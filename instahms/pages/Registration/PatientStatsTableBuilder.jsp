...
<html>
	<body onload="onInit()">
		<div class="pageHeader">Patient Stats Tabular Report</div>
		<form name="inputform" method="GET" action="${cpath}/registration/PatientStatsReport.do">
			...
			<div class="tipText">
				This report gives you a tabular summary of the patients count between two dates, organized
				by patient type and a secondary grouping of your choice.
			</div>
