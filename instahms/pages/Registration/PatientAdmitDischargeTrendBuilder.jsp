...
<html>
	<body onload="onInit()">
		<div class="pageHeader">Patient Admission & Discharge Trend Report</div>
		<form name="inputform" method="GET" action="${cpath}/registration/PatientStatsAdmitDischarge.do">
			...
			<div class="tipText">
				This report gives you a trend of the  patient admission & discharge count between two dates, organized
			...
			<table align="center">
				...
				<tr>
					...
					<td>
						<select name="groupBy">
							<option value="visit_type">Patient Type</option>
			...
			<table align="center" style="margin-top: 1em">
				<tr>
						<td>
							<button type="submit" accesskey="V" onclick="return onSubmit('screen')">
							<b><u>V</u></b>iew</button>
						</td>
						<td>
