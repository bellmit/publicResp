...
<html>
	<body onload="onInit()">
		<div class="pageHeader">Patient Visit Stats Trend Report</div>
		<form name="inputform" method="GET" action="${cpath}/registration/PatientStatsVisitTrend.do">
			...
			<div class="tipText">
				This report gives you a trend of the patient visit count between two dates, organized
