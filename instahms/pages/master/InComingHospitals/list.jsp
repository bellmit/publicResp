...
<title>Incoming Hospitals Master - Insta HMS</title>
	...
	<script type="text/javascript">
		var toolBar = {
			Edit : {
				...
				onclick : null,
				description : "View and/or Edit the contents of this Incoming Hospital"
				}
		};
...
<h1>In Coming Hospital Master</h1>

<insta:feedback-panel/>

<form name="IncomingHospitalForm" method="GET">
	...
	<insta:search-lessoptions form="IncomingHospitalForm" >
			<div class="searchBasicOpts" >
				<div class="sboField">
					<div class="sboFieldLabel">Hospital Name:</div>
					<div class="sboFieldInput">
						<input type="text" name="hospital_name" value="${ifn:cleanHtmlAttribute(param.hospital_name)}" />
						<input type="hidden" name="hospital_name@op" value="ico"/>
					</div>
				</div>
	...
	<div class="resultList" >
		<table class="resultList" cellspacing="" cellpadding="" id="resultTable" onmouseover="hideToolBar();">
			<tr onmouseover="hideToolBar();">
				<th>#</th>
				<insta:sortablecolumn name="hospital_name" title="Hospital Name"/>
			</tr>
			<c:forEach var="record" items="${pagedList.dtoList}" varStatus="st">
				<tr class="${st.index == 0 ? 'firstRow' : ''} ${st.index % 2 == 0 ? 'even' : 'odd'}" id="toolbarRow${st.index}"
					onclick="showToolbar(${st.index}, event, 'resultTable', {hospital_id: '${record.hospital_id}'},'');">
