...
<form action="ICDCodesMaster.do" method="POST">
	<input type="hidden" name="_method" value="${param._method == 'add' ? 'create' : 'update'}">
	<input type="hidden" name="old_code"  value="${bean.map.code}"/>
	<input type="hidden" name="old_code_type"  value="${bean.map.code_type}"/>

	<div class="pageHeader">${param._method == 'add' ? 'Add' : 'Edit'} Codes </div>
	...
	<table class="formtable">
		<tr>
			...
			<td>
				<input type="text" name="code"  value="${bean.map.code}" id="code"
					maxlength="100"  />
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
		...
		<tr>
			...
			<td colspan="5">
				<input type="text" name="code_desc" style="width: 100%" value="${bean.map.code_desc}" id="code_desc"  size="60" />
			</td>
		</tr>
		<tr>
			<td class="formlabel">Code Type:</td>
			<td>
					<insta:selectdb name="code_type" value="${bean.map.code_type}" table="mrd_supported_code_types" id="code_type"
	...
	<div class="screenActions">
		...
		<a href="javascript:void(0)" onclick="doClose();">Codes List</a>
	</div>
