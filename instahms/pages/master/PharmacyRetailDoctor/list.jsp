...
<title>Pharmacy Retail Doctors List - Insta HMS</title>
	...
	<script type="text/javascript">
		var toolBar = {
			Edit : {
				...
				href : "/master/PharmacyRetailDoctor.do?_method=show",
				onclick : null,
				description : "View and/or Edit the contents of this Pharmacy Retail doctors"
				}
		};
...
<h1>Pharmacy Retail Doctors</h1>

<insta:feedback-panel/>

<form name="PharmRetailDocForm" method="GET">
	...
	<insta:search-lessoptions form="PharmRetailDocForm" >
			<div class="searchBasicOpts" >
				<div class="sboField">
					...
					<div class="sboFieldInput">
						...
						<input type="hidden" name="doctor_name@op" value="ico"/>
					</div>
				</div>
	...
	<div class="resultList" >
		<table class="resultList" cellspacing="" cellpadding="" id="resultTable" onmouseover="hideToolBar();">
			...
			<c:forEach var="record" items="${pagedList.dtoList}" varStatus="st">
				<tr class="${st.index == 0 ? 'firstRow' : ''} ${st.index % 2 == 0 ? 'even' : 'odd'}" id="toolbarRow${st.index}"
					onclick="showToolbar(${st.index}, event, 'resultTable', {doctor_id: '${record.doctor_id}'},'');">
		...
		<c:url var="Url" value="PharmacyRetailDoctor.do">
			<c:param name="_method" value="add"/>
		</c:url>

		<div class="screenActions" style="float: left">
			<a href="${Url}">Add New Doctor</a>
		</div>
