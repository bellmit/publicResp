...
<body onload="focus()">
<c:set var="actionUrl" value="${cpath}/${pagePath}/update.htm?bill_label_id=${bean.account_group_id}"/>

	<form action="${actionUrl}" method="POST">

		<input type="hidden" name="method" value="update">
		<input type="hidden" name="account_group_id" value="${bean.account_group_id}"/>
		...
		<table class="screenActions">
			<tr>
				...
				<td>&nbsp;|&nbsp;<a href="${cpath}/${pagePath}/add.htm?method=add" >Add</a></td>
				<td>&nbsp;|&nbsp;</td>
				<td>
