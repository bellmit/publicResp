...
<h1 style="float:left">Edit Transfer Hospital</h1>
...
<form action="update.htm" name="transferHospForm" method="POST">
	 
	<input type="hidden" name="transfer_hospital_id" value="${bean.transfer_hospital_id}"/>
	...
	<table class="formtable">
		<tr>
			...
			<td>
				<input type="text" name="transfer_hospital_name" value="${bean.transfer_hospital_name}"
		...
		<tr>
			...
			<td>
				<input type="text" name="transfer_hospital_service_regn_no" value="${bean.transfer_hospital_service_regn_no}"
