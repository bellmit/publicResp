	...
	<script type="text/javascript">
		var toolbar = {
			Edit: {
				...
				href: 'master/CategoryMaster.do?_method=show',
				onclick: null,
...
<body onload="init();">
	...
	<form name="CategorySearchForm" method="GET">
		...
		<c:url var="addNew" value="CategoryMaster.do">
			<c:param name="_method" value="add"/>
		</c:url>

		<div class="screenActions" style="float:left"><a href="${addNew}">Add New Category</a></div>
