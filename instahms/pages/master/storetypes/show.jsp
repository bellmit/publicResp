...
<title>Edit Store Type- Insta HMS</title>
<insta:link type="script" file="hmsvalidation.js"/>
	<script>
		function keepBackUp(){
				backupName = document.storetypemasterform.store_type_name.value;
		}
       ...
       Insta.masterData=${ifn:convertListToJson(stortypedetails)};
	</script>
</head>
<body onload= "keepBackUp();" >
<h1 style="float:left">Edit Store Type</h1>
<c:url var="searchUrl" value="/master/storetypes/show.htm"/>
<insta:findbykey keys="store_type_name,store_type_id" fieldName="store_type_id" method="show" url="${searchUrl}"/>
<form action="${cpath}${pagePath}/update.htm"  name="storetypemasterform"method="POST">
	<input type="hidden" name="store_type_id" value="${bean.store_type_id}"/>
