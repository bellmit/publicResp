...
<html>
	<head>
		...
		<script>
			function deleteSelected(e) {
				var deleteEl = document.getElementsByName("deleteBillPrint");
			...
			var toolbar = {
				Edit: {
					...
					href: 'master/BillPrintTemplate.do?method=show',
					onclick: null,
	...
	<body onload="init();">
		<h1>Bill Print Templates</h1>

		<insta:feedback-panel/>

		<form metod="POST" action="BillPrintTemplate.do">
				...
				<table class="resultList" cellspacing="0" cellpadding="0" id="resultTable" onmouseover="hideToolBar('');">
					...
					<c:forEach var="temp" items="${templateList}" varStatus="st">
						<tr class="${st.index == 0 ? 'firstRow' : ''} ${st.index % 2 == 0 ? 'even' : 'odd'}"
							...
							<td><input type="checkbox" name="deleteBillPrint" id="deleteBillPrint"
