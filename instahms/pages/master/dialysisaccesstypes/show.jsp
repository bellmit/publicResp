...
<body>
	<form action="update.htm" method="POST">
		...
		<h1>  ${editText} <insta:ltext key="generalmasters.dialysisaccesstypes.addoredit.dialysisaccesstype"/></h1>
		
		<insta:feedback-panel/>
		<input type="hidden" name="access_type_id" value="${bean.access_type_id}"/>
		<c:set var="status">
		...
		<tr>
			...
			<td>&nbsp;|&nbsp;</td>
			<td><a href="#" onclick="window.location.href='${cpath}/master/dialysisaccesstypes/add.htm'"><insta:ltext key="generalmasters.dialysisaccesstypes.addoredit.add"/></a></td>
			<td>&nbsp;|&nbsp;</td>
