...
<script>
 ...
 var discountPlanDetailsbean  = ${ifn:convertListToJson(discountPlanDetailsbean)}; //${discountPlanDetailsbean};
...
<body onload="init();" >
	...
	<form  name="DiscountPlanMasterForm" action="${cpath}${pagePath}/create.htm" method="post"> 
