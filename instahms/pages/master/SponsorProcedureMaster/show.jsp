...
<script>
	function doClose() {
		window.location.href = "${cpath}/${pagePath}/list.htm?_method=list&status=A&sortOrder=tpa_name&sortReverse=false";
	}
...
<form action="${param._method == 'add' ? 'create' : 'update'}.htm" method="POST">
	<input type="hidden" name="_method" value="${param._method == 'add' ? 'create' : 'update'}">
	<c:if test="${param._method == 'show'}">
		<input type="hidden" name="procedure_no" value="${bean.procedure_no}"/>
	</c:if>
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable" align="center">
			<tr>
				...
				<td>
					<insta:selectdb name="tpa_id" table="tpa_master" orderby="tpa_name"
						valuecol="tpa_id" displaycol="tpa_name" filtered="false" value="${bean.tpa_id}"/>
				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>
					<input type="text" name="procedure_code" value="${bean.procedure_code}"
			...
			<tr>
				...
				<td>
					<input type="text" name="procedure_name" value="${bean.procedure_name}"
			...
			<tr>
				<td>Limit:</td>
				<td>
					<input type="text" name="procedure_limit" value="${bean.procedure_limit}"
			...
			<tr>
				<td>Remarks:</td>
				<td>
					<input type="text" name="remarks" value="${bean.remarks}" size="50" length="100"/>
				</td>
			</tr>
			<tr>
				<td>Status</td>
	...
	<table class="screenActions">
		<tr>
			...
			<c:if test="${param._method=='show'}">
				<td>&nbsp;|&nbsp;</td>
				<td><a href="#" onclick="window.location.href='${cpath}/${pagePath}/add.htm?_method=add'">Add</a></td>
			</c:if>
			<td>&nbsp;|&nbsp;</td>
