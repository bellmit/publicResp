...
<form name="CMICDCodesForm" method="GET">
	...
	<insta:find form="CMICDCodesForm" optionsId="optionalFilter" closed="${hasResults}">
...
<div class="resultList">
		...
		<c:forEach var="record" items="${pagedList.dtoList}" varStatus="st">
			...
			<tr class="${st.index == 0 ? 'firstRow' : ''} ${st.index % 2 == 0 ? 'even' : 'odd'}" id="toolbarRow${st.index}"
					onclick="showToolbar(${st.index}, event, 'resultTable',
						{mrd_code_id: '${record.mrd_code_id}'}, '');" >
	...
	<div class="screenActions" style="float: left">
		<a href='<c:out value="${cpath}${pagepath}/add.htm" />'>Add New Code</a>
