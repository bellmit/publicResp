...
<html>
	<head>
		...
		<title>Pharmacy Purchase Order Print Template</title>
		...
		<script>
			...
			var toolbar = {
				Edit: {
					...
					href: 'master/POPrintTemplate.do?method=show',
					onclick: null,
	...
	<body onload="init();">
		...
		<h1>Pharmacy Purchase Order Print Templates</h1>

		<insta:feedback-panel/>

		<form metod="POST" action="POPrintTemplate.do">
			...
			<c:url var="url" value="POPrintTemplate.do">
			...
			|<a href="<c:out value='${url}' />"> Add New Pharmacy Purchase Order Print Template</a></div>
