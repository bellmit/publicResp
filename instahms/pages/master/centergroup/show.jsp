...
<html>
	<head>
		...
		<script>
			...
			var applicable_centers = ${ifn:convertListToJson(applicable_centers)};
	...
	<body onload="init();">
		<h1>Edit Center Group Applicability </h1>
		<insta:feedback-panel/>
		<c:set var="actionUrl" value="show.htm"/>
		<form action="update.htm" name="center_group_association_form" method="post">
		<table class="formtable">
			<tr>
				...
				<td>
					...
					<input type="hidden" name="center_group_id" value="${bean.center_group_id}"/>
				</td>
			 		...
			 		<c:forEach begin="1" end="${app_for_all_centers ? 1 : app_centers_count+1}" var="i" varStatus="loop">
						...
						<tr style="display: ${empty app_center ? 'none' : 'table-row'}">
							<td>
								...
								<input type="hidden" name="center_status" value="${app_center.cg_status}"/>
