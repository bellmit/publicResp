...
<script>
	...
	function keepBackUp(){
				backupName = document.regionMaster.region_name.value;
	}
...
<body onload="keepBackUp();">
	...
	<c:set var="actionUrl" value="${cpath}/master/regions/update.htm?region_id=${bean.region_id}"/>
...
<form action="${actionUrl}" method="POST" name="regionMaster">
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			<tr>
				...
				<td>
					<input type="text" name="region_name" id="region_name" value="<c:out value="${bean.region_name}"/>" maxlength="100" class="required" title="Region Name is mandatory."><span class="star">*</span>
				</td>
				<td/>
				<td/>
				<td/>
	...
	<div class="screenActions">
		...
		<insta:screenlink addPipe="true" screenId="mas_region" label="Region List"  extraParam="?sortOrder=region_id&sortReverse=false&status=A"/>
			| <a href="${cpath}/master/regions/add.htm?" >Add</a>
	</div>
</form>
