...
<form action="create.htm" method="POST" name="editDiagMethodologyForm">
...
<table class="formtable">
	...
	<tr>
		...
		<td><textarea rows="5" cols="20" name="method_desc"></textarea>
		</td>
	</tr>
	<tr>
		<td class="formlabel">Status:</td>
		<td><insta:selectoptions name="status" value=""
