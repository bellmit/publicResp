...
<head>
	...
	<title>CM ICD Codes List - Insta HMS</title>
	...
	<script type="text/javascript">
		var toolbar = {
			Edit: {
				...
				onclick: null,
				description: "View and/or Edit the contents of this CM ICD Code"
				}
		};
		function init() {
...
<div class="resultList">
	...
	<c:url var="url" value="ICDCodeMaster.do">
			<c:param name="_method" value="add"/>
	</c:url>
	<div class="screenActions" style="float: left">
		<a href="<c:out value='${url}' />">Add New ICD Code</a>
