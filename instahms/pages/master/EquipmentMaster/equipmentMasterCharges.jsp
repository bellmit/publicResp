...
<html>
	...
	<body class="yui-skin-sam" onload="fillRatePlanDetails('${bean.map.eq_id}');">
		...
		<h1 style="float: left">Equipment Charges</h1>
	 	<insta:findbykey keys="equipment_name,eq_id" fieldName="equip_id" method="showCharges" url="${searchUrl}"
	 			extraParamKeys="org_id" extraParamValues="${bean.map.org_id}"/>

		<insta:feedback-panel/>
		<form action="EquipmentMaster.do" name="showform" method="GET">		<%-- for rate plan change --%>
		...
		<form action="EquipmentMaster.do" name="chargesForm" method="POST">
			...
			<table class="formtable">
				<tr>
					...
					<td>
						<insta:selectdb name="org_id" value="${bean.map.org_id}" table="organization_details" valuecol="org_id" orderby="org_name"
			...
			<table class="screenActions">
				<tr>
					...
					<td>&nbsp;|&nbsp;</td>
					<td><a href="${pageContext.request.contextPath}/master/EquipmentMaster.do?_method=show&equip_id=${bean.map.eq_id}&org_id=${bean.map.org_id}" >Equipment Details</a></td>
					<td>&nbsp;|&nbsp;</td>
