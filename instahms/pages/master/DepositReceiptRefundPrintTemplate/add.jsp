...
function funclose(){
	document.forms[0]._method.value='list';
...
<body>
<div class="pageHeader">Deposit Receipt/Refund Print Template</div>
<span align="center" class="error">${ifn:cleanHtml(error)}</span>
<span align="center"><b>${ifn:cleanHtml(msg)}</b></span>

<form method="POST" action="DepositReceiptRefundTemplate.do">
