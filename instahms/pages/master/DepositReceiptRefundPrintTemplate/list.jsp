	...
	<script>
		...
		var toolbar = {
			Edit: {
				...
				href: 'master/DepositReceiptRefundTemplate.do?_method=show',
				onclick: null,
		...
		function addNew()
		{
			window.href.location = 'DepositReceiptRefundTemplate.do?_method=selectMode';
		}
...
<body onload="init();">
	...
	<h1>Deposit Receipt/Refund Print Templates</h1>

	<insta:feedback-panel/>

	<form metod="POST" action="DepositReceiptRefundTemplate.do">
		...
		<c:url var="url" value="DepositReceiptRefundTemplate.do">
			<c:param name="_method" value="selectMode"/>
		</c:url>
