...
<script>
	...
	var backupName = '';
	function keepBackUp(){
		backupName = document.phraseSuggestionsCategoryMaster.phrase_suggestions_category.value;
	}
...
<form action="update.htm" method="POST" name="phraseSuggestionsCategoryMaster">
	<input type="hidden" name="_method" value="update"> 
	<input type="hidden" name="phrase_suggestions_category_id" id="phrase_suggestions_category_id" value="${bean.phrase_suggestions_category_id}"/>

	<h1>Edit Phrase Suggestions Category </h1>
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			<tr>
				...
				<td>
					<input type="text" name="phrase_suggestions_category" id="phrase_suggestions_category" value="<c:out value="${bean.phrase_suggestions_category}" />" maxlength="100" class="required" title="Phrase Suggestions Category Name is mandatory."><span class="star">*</span>
				</td>
				<td/>
				<td/>
				<td/>
