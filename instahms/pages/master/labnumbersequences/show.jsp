...
<body>
 <h1><insta:ltext key="patient.sequences.labnumbersequences.editlabnumbersequencepreference"/></h1>
	...
	<table class="formtable" >
		<tr>
			...
			<td>
				...
				<input type="hidden" name="lab_number_seq_id" value="${bean.lab_number_seq_id}"/>
			</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
			<td>&nbsp;</td>
