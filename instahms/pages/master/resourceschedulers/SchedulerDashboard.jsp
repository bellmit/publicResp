...
<title><insta:ltext key="patient.resourcescheduler.schedulerdashboard.title"/></title>
	...
	<script>
		...
		Edit: {
			...
			href: '${pagePath}/editAppointmentScheduler.htm?_method=show',
			onclick: null,
...
<c:set var="dept">
 <insta:ltext key="patient.resourcescheduler.schedulerdashboard.department"/>
	...
	<insta:search form="CategorySearchForm" optionsId="optionalFilter" closed="${hasResults}">
	...
	<c:url var="url" value="categorymaster.do">
