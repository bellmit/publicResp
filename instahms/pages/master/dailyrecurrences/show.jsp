...
<title>Add/Edit Recurrence - Insta HMS</title>
...
<body onload="init();">
	<form name="recurrenceDailyMaster" action="update.htm" method="POST">
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			<tr>
				...
				<td><div id="autocomplete" style="padding-bottom: 20px;">
						<input type="text" name="display_name" id="display_name" style="width:138px;"
							value="${bean.display_name}" ${ReadOnly}/>
						<div id="displaycontainer" style="width:240px;"></div>
					</div>
					<input type="hidden" name="recurrence_daily_id" id="recurrence_daily_id" value="${bean.recurrence_daily_id}"/>
				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>
					<textarea name="timings" id="timings" style="width: 138px;" onblur="countNoOfActivities()">${bean.timings}</textarea>
				</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td><insta:selectoptions name="medication_type" value="${bean.medication_type}" opvalues="M,IV,A" optexts="All Medicines,Only IV,Only Additive" /></td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
				<td>&nbsp;</td>
			...
			<tr>
				...
				<td>
					<label class="forminfo" id="noofact">${bean.num_activities}</label>
				</td>
			</tr>
			<tr>
				<td class="formlabel">Display Order:</td>
				<td>
					<input type="text" name="display_order" id="display_order" value="${bean.display_order}"
		...
		<button type="button" accesskey="S" onclick="return doSave()" ${bean.recurrence_daily_id== -1 ? 'disabled' : ''}><b><u>S</u></b>ave</button>
