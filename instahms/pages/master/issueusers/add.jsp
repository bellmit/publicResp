...
<form  name="IssueUserMasterForm" action="create.htm" method="POST">
    <table width="100%">
		<tr>
			<td width="100%"><h1><insta:ltext key="sales.issues.user.adddetails"/></h1></td>
		</tr>
	</table>
		...
		<table class="formtable" cellpadding="0" cellspacing="0" width="100%" >
			<tr>
				...
				<td class="forminfo" >
					...
					value="${bean.map.hosp_user_name}" onkeypress="return enterAlphanNumericals(event);" 
					onblur="checkName();" maxlength="60"/>
				</td>
			</tr>
			<tr>
				<td class="formlabel" width="100px" ><insta:ltext key="sales.issues.user.status"/>: </td>
				<td class="forminfo" >
					<insta:selectoptions name="status" id="status" value="${bean.map.status}" opvalues="A,I"
