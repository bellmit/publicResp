...
<insta:link type="script" file="master/sequences/hospitalIdPatterns.js"/>
	<script>
       ...
       function validateForm() {
    		var patternId = document.auditcontrolsequencepreferenceform.pattern_id.value;
    		var priority = document.auditcontrolsequencepreferenceform.priority.value;
    		if(patternId == '') {
    			alert('Please enter Pattern Id.');
    			document.auditcontrolsequencepreferenceform.pattern_id.focus();
    			return false;
    		}
    		if(priority == ''){
...
<body onload="init()">
 <h1><insta:ltext key="patient.sequences.auditcontolsequences.addauditcontrolsequencepreference"/></h1>
