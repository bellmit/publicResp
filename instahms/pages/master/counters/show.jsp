...
<insta:link type="script" file="hmsvalidation.js"/>
	...
	<script>
	    ...
	    Insta.masterData=${ifn:convertListToJson(countersLists)};
...
<body onload="focus(); keepBackUp();">
  ...
  <h1 style="float:left">Edit Counter</h1>
  <c:url var="searchUrl" value="${pagePath}/show.htm"/>
  <insta:findbykey keys="counter_no,counter_id" fieldName="counter_id" method="show" url="${searchUrl}"/>

<form action="update.htm" name="counterForm" method="POST">
	
	<input type="hidden" name="counter_id" value="${bean.counter_id}"/>
