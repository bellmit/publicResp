...
<body onload="init()">
 <h1><insta:ltext key="patient.sequences.pharmacybillidsequences.addpharmacybillidsequencepreference"/></h1>
...
<form action="${actionUrl}"  name="pharmacybillidsequencepreferenceform" method="POST">
	...
	<table class="formtable" >
		<tr>
			...
			<td>
				<insta:selectoptions name="visit_type" value="" opvalues="i,o,r" optexts="In Patient,Out Patient,Retail" dummyvalue="All" dummyvalueId="*"/>
			</td>
		</tr>
		<tr>	
			<td class="formlabel"><insta:ltext key="patient.sequences.pharmacybillidsequences.deptid"/>:</td>
			<td>
				<insta:selectdb name="dept_id" value="" table="stores" valuecol="dept_id" displaycol="dept_name" 
			...
			<td>
				<insta:selectoptions name="sale_type" value="" opvalues="S,R" optexts="Sales,Returns" dummyvalue="All" dummyvalueId="*"/>
			</td>
		</tr>
	</table>
	</fieldset>
