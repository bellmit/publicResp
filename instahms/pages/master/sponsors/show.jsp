...
<c:set var="actionUrl" value="${cpath}/${pagePath}/update.htm"/>
	<form  name="sponsorMasterForm" action="${actionUrl}" method="POST">
		...
		<table width="100%">
						<tr>
							<td width="100%"><h1>Edit Sponsor Type Details</h1></td>
							<td>&nbsp; &nbsp;</td>
						</tr>
		</table>
		...
		<fieldset class="fieldSetBorder" id="corporateInsu1">
			<table class="formtable" cellpadding="0" cellspacing="0" width="100%" >
				<tr>
					...
					<td class="forminfo" >
						<input type="text" name="sponsor_type_name" id="sponsor_type_name" maxlength="100" value="${bean.sponsor_type_name}" />
					</td>
				...
				<tr>
					...
					<td class= "forminfo" colspan="5">
						<textarea COLS=61 ROWS=3 name="sponsor_type_description"   id="sponsor_type_description" >${bean.sponsor_type_description}</textarea>
				    </td>
				</tr>
			 </table>
		 </fieldset>
		...
		<table  class="formtable" cellpadding="0" cellspacing="0" width="100%">
			<tr>
				...
				<td class="forminfo">
					<input type="text" name="plan_type_label" id="plan_type_label" maxlength="100" value="${bean.plan_type_label}" />
				</td>
				<td class="formlabel">
				</td>
				<td></td>
	    ...
	    <table class="detailList"  id="" cellpadding="0" cellspacing="0" width="100%">
			...
			<tr>
				...
				<td>
					<input type="hidden" name="member_id_show" id="member_id_show" value="${bean.member_id_show}"/>
							<input type="checkbox" name="member_id_show1" id="member_id_show1" value="${bean.member_id_show}" onclick="markApplicable(this);"
								<c:if test="${bean.member_id_show == 'Y' }"> checked </c:if> />
				</td>
				<td>
					<input type="hidden" name="member_id_mandatory" id="member_id_mandatory" value="${bean.member_id_mandatory}"/>
							<input type="checkbox" name="member_id_mandatory1" id="member_id_mandatory1" value="${bean.member_id_mandatory}" onclick="markApplicable(this);"
								<c:if test="${bean.member_id_mandatory == 'Y' }"> checked </c:if>
								<c:if test="${bean.member_id_show == 'N' }"> disabled </c:if>  />
				</td>
				<td>
					 <input type="text" name="member_id_label" id="member_id_label" maxlength="100"  value="${bean.member_id_label}" />
				</td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
					 <input type="hidden" name="policy_id_show" id="policy_id_show" value="${bean.policy_id_show}"/>
							<input type="checkbox" name="policy_id_show1" id="policy_id_show1" value="${bean.policy_id_show}" onclick="markApplicable(this);"
								<c:if test="${bean.policy_id_show == 'Y' }"> checked </c:if>  />
				</td>
				<td>
					<input type="hidden" name="policy_id_mandatory" id="policy_id_mandatory" value="${bean.policy_id_mandatory}"/>
							<input type="checkbox" name="policy_id_mandatory1" id="policy_id_mandatory1" value="${bean.policy_id_mandatory}" onclick="markApplicable(this);"
								<c:if test="${bean.policy_id_mandatory == 'Y' }"> checked </c:if>
								<c:if test="${bean.policy_id_show == 'N' }"> disabled </c:if> />
				</td>
				<td></td>
				<td></td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="hidden" name="validity_period_show" id="validity_period_show" value="${bean.validity_period_show}"/>
							<input type="checkbox" name="validity_period_show1" id="validity_period_show1" value="${bean.validity_period_show}" onclick="markApplicable(this);"
								<c:if test="${bean.validity_period_show == 'Y' }"> checked </c:if>  />
				</td>
				<td>
					<input type="hidden" name="validity_period_mandatory" id="validity_period_mandatory" value="${bean.validity_period_mandatory}"/>
							<input type="checkbox" name="validity_period_mandatory1" id="validity_period_mandatory1" value="${bean.validity_period_mandatory}" onclick="markApplicable(this);"
								<c:if test="${bean.validity_period_mandatory == 'Y' }"> checked </c:if>
								<c:if test="${bean.validity_period_show == 'N' }"> disabled </c:if> />
				</td>
				<td></td>
				<td>
					<input type="hidden" name="validity_period_editable" id="validity_period_editable" value="${bean.validity_period_editable}"/>
							<input type="checkbox" name="validity_period_editable1" id="validity_period_editable1" value="${bean.validity_period_editable}" onclick="markApplicable(this);"
								<c:if test="${bean.validity_period_editable == 'Y' }"> checked </c:if>
								<c:if test="${bean.validity_period_show == 'N' }"> disabled </c:if> />
				</td>
			</tr>
			...
			<tr>
				...
				<td>
					<input type="hidden" name="prior_auth_show" id="prior_auth_show" value="${bean.prior_auth_show}"/>
							<input type="checkbox" name="prior_auth_show1" id="prior_auth_show1" value="${bean.prior_auth_show}" onclick="markApplicable(this);"
								<c:if test="${bean.prior_auth_show == 'Y' }"> checked </c:if> />
			...
			<tr>
				<td>Visit Limits</td>
				<td>
				<input type="hidden" name="visit_limits_show" id="visit_limits_show" value="${bean.visit_limits_show}"/>
							<input type="checkbox" name="visit_limits_show1" id="visit_limits_show1" value="${bean.visit_limits_show}" onclick="markApplicable(this);"
								<c:if test="${bean.visit_limits_show == 'Y' }"> checked </c:if> />
				</td>
				<td></td>
				<td></td>
				<td></td>
		...
		<div class="screenActions">
				...
				<a href="${cpath}/${pagePath}/add.htm?_method=add" >|&nbsp; Add &nbsp;|</a>
