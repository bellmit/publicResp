...
<body onload="init();">
	<h1>Prescription Label Print Templates</h1>	
	<script>
	...
	var toolbar = {
		Edit: {
			...
			href: 'master/PrescriptionsLabelPrintTemplates.do?method=show',
			onclick: null,
	...
	<form method="POST" action="PrescriptionsLabelPrintTemplates.do">
		...
		<c:url var="url" value="PrescriptionsLabelPrintTemplates.do">
		...
		<div class="screenActions">
			<c:if test="${not empty templateList}">
				...
				<a href="<c:out value='${url}' />"> Add New Prescriptions Print templates</a>
		</div>
