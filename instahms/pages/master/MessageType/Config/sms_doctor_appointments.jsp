...
<form action="${cpath}/master/${urlPrefix}/${ifn:cleanURL(param.message_type_id)}/MessageConfig.do" method="POST">
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			...
			<tr>
				<td class="formlabel">Show Doctors with appointments in the <b>next</b> </td>
				<td>
					...
					name="param_value_${configMap['due_period'].map.message_configuration_id}"
					value="${configMap['due_period'].map.param_value}" />
