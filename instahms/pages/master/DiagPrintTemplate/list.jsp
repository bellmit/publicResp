...
<html>
	<head>
		...
		<script>
			function deleteSelected(e) {
				var deleteEl = document.getElementsByName("deleteDiagPrint");
			...
			Edit: {
				...
				href: 'master/DiagPrintTemplate.do?method=show',
				onclick: null,
	...
	<body onload="init();">
		...
		<form metod="POST" action="DiagPrintTemplate.do">
			...
			<input type="hidden" name="method" value="delete"/>
					...
					<table class="resultList" cellspacing="0" cellpadding="0" id="resultTable" onmouseover="hideToolBar('');">
						...
						<c:forEach var="temp" items="${templateList}" varStatus="st">
							<tr class="${st.index == 0 ? 'firstRow' : ''} ${st.index % 2 == 0 ? 'even' : 'odd'}"
								...
								<td><input type="checkbox" name="deleteDiagPrint" id="deleteDiagPrint"
				...
				<div>
				<c:url var="url" value="DiagPrintTemplate.do">
				...
				<table class="screenActions">
					<tr>
						<td>
							...
							|
							<a href="${ifn:cleanHtmlAttribute(url)}">Add New Diagnostic Outhouse Print Template</a>
						</td>
					</tr>
				</table>
		</form>
