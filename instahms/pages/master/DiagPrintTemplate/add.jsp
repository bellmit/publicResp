...
<head>
	...
	function validateForm(){
		var mode = document.diagprint.templateMode;
	...
	function closeTemplate(){
		document.diagprint.method.value='list';
...
<body>
	...
	<form method="POST"  name="diagprint" action="DiagPrintTemplate.do">
		...
		<table class="screenActions">
			<tr>
				...
				<td>&nbsp;|&nbsp;<a href="javascript:void(0)" onclick="closeTemplate();">Diagnostic Print List </a></td>
			</tr>
		</table>
