...
<body>
	...
	<form method="POST"  name="pharmacyprint" action="PharmacyPrintTemplate.do">
		...
		<table>
			<tr>
				...
				<td>&nbsp;|&nbsp;<a href="javascript:void(0)" onclick="closeTemplate();">Pharmacy Print Template List</a></td>
			</tr>
		</table>
