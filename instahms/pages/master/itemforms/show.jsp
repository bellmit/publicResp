...
<title>Add/Edit Item Form - Insta HMS</title>
<script>
	function validate() {
...
<form action="update.htm" method="POST" name="ItemForm" >
	<input type="hidden" name="item_form_id" value="${bean.item_form_id}"/>
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			<tr>
				...
				<td>
					<input type="text" name="item_form_name" id="item_form_name" value="${bean.item_form_name}" />
				</td>
			...
			<tr>
				...
				<td><insta:selectoptions name="granular_units" value="${bean.granular_units}" opvalues="Y,N" optexts="Yes,No" /></td>
				<td class="formlabel">&nbsp;</td>
				<td>&nbsp;</td>
				<td class="formlabel">&nbsp;</td>
				<td>&nbsp;</td>
