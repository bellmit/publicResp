...
<script>
	...
	View: {
		...
		href: '/master/paymentterms/show.htm?',
		onclick: null,
...
<c:set var="pagePath" value="<%=URLRoute.PAYMENT_TERMS_MASTER_PATH %>"/>
...
<form name="tempListSearchForm" method="GET">
	...
	<insta:find form="tempListSearchForm" optionsId="optionalFilter" closed="${hasResults}" >
    ...
    <div class="screenActions">
		<a href="${cpath }/${pagePath}/add.htm">Add New Template</a>
	</div>
