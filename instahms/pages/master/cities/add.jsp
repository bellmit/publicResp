...
<c:set var="actionUrl" value="${cpath}/master/cities/create.htm"/>
<form action="${actionUrl}" method="POST">
	<input type="hidden" name="city_id" value=""/>
	<div class="pageHeader">Add City</div>
				...
				<tr>
					...
					<td>
						 <insta:selectdb name="district_id" value="${bean.district_id}" table="district_master" 
						 	...
						 	dummyvalue="-- Select --" dummyvalueId="" filtercol="state_id" filtervalue="${bean.state_id}" />
					</td>
				</tr>
			</c:if>
