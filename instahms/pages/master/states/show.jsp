...
<form action="${actionUrl}" method="POST">
	...
	<input type="hidden" name="state_id" value="${bean.state_id}"/>
	...
	<table class="screenActions">
		<tr>
			<td><button type="submit" accesskey="S" onclick="return restrictInactiveState()"><b><u>S</u></b>ave</button></td>
				...
				<td>&nbsp;|&nbsp;</td>
				<td><a href="javascript:void(0)" onclick="window.location.href='${cpath}/${pagePath}/add.htm?_method=add' ">Add</a></td>
