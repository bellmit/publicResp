...
<form action="create.htm" method="POST" name="phraseSuggestionsMaster">
	<c:set var="selectPrompt">
			<insta:ltext key="selectdb.dummy.value"/>
	</c:set>
	<input type="hidden" name="_method" value="create">
	<h1>Add Phrase Suggestion </h1>
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			...
			<tr>
				...
				<td>
					<input type="text" name="phrase_suggestions_desc" id="phrase_suggestions_desc" class="required" title="Phrase Suggestion Name is mandatory."><span class="star">*</span>
				</td>
				<td/>
				<td/>
				<td/>
