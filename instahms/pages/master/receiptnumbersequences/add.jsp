...
<insta:link type="script" file="master/sequences/hospitalIdPatterns.js"/>
	<script>
       ...
       function validateForm() {
    		var patternId = document.receiptnumbersequencepreferenceform.pattern_id.value;
    		var priority = document.receiptnumbersequencepreferenceform.priority.value;
    		if(patternId == '') {
    			alert('Please enter Pattern Id.');
    			document.receiptnumbersequencepreferenceform.pattern_id.focus();
    			return false;
    		}
    		if(priority == ''){
...
<body onload="init()">
 <h1><insta:ltext key="patient.sequences.receiptnosequences.addreceiptnosequencepreference"/></h1>
...
<form action="${actionUrl}"  name="receiptnumbersequencepreferenceform" method="POST">
	...
	<table class="formtable" >
		...
		<tr>
			...
			<td>
				<insta:selectoptions name="payment_type" value="" opvalues="R,F,S" optexts="Receipt,Refund,Sponsor Receipts" dummyvalue="All" dummyvalueId="*"/>
			</td>
		</tr>
	</table>
	</fieldset>
