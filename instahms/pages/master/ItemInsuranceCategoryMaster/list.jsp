	...
	<script type="text/javascript">
		var toolBar = {
			Edit : {
				...
				href : "/Insurance/ItemInsuranceCategoryMaster.do?_method=show",
				onclick : null,
...
<body onload="init()">
	...
	<form name="itemInsuranceCategoryMasterForm" method="GET">
		...
		<div class="resultList" >
			<table class="resultList" cellspacing="" cellpadding="" id="resultTable" onmouseover="hideToolBar();">
				<tr onmouseover="hideToolBar();">
					...
					<insta:sortablecolumn name="priority" title="Priority"/>
				</tr>
		...
		<c:url var="Url" value="ItemInsuranceCategoryMaster.do">
			<c:param name="_method" value="add"/>
		</c:url>

		<div class="screenActions" style="float: left">
			<a href="<c:out value='${Url}' />">Add New Insurance Item Category</a>
		</div>
</form>
</body>
</html>
