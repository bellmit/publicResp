...
<head>
	...
	<title>Add Form - Insta HMS</title>
	<script>
...
<body onload="init();">
	...
	<form action="create.htm" method="POST" name="componentsform">
		<fieldset class="fieldSetBorder">
			<table class="formtable">
							...
							<td >
								<select name="operation_id" id="operation_id" class="dropdown" >
									...
									<c:forEach items="${ops}" var="op">
										<option value="${op.op_id}">${op.operation_name}</option>
									</c:forEach>
								</select>
							</td>
							...
							<td>
								<select name="service_id" id="service_id" class="dropdown" >
									...
									<c:forEach items="${serv}" var="ser">
										<option value="${ser.service_id}" ><c:out value="${ser.service_name}"/></option>
									</c:forEach>
								</select>
							</td>
							<td class="formlabel">&nbsp;</td>
							...
							<td>
								<select name="doctor_id" id="doctor_id" class="dropdown" >
									...
									<c:forEach items="${doctors}" var="doc">
										<option value="${doc.doctor_id}" ><c:out value="${doc.doctor_name}"/></option>
									</c:forEach>
								</select>
							</td>
							<td class="formlabel">&nbsp;</td>
						...
						<td>
							<select class="dropdown" name="print_template_id" id="print_template_id">
								...
								<c:forEach items="${templateList}" var="printTemp">
									<option value="${printTemp.print_template_id}">${printTemp.template_name}</option>
								</c:forEach>
							</select>
						</td>
					</tr>
						...
						<select class="dropdown" name="doc_type" id="doc_type">
							<option value="">Select DocType</option>
								<c:forEach items="${doctypelist}" var="docType">
									<option value="${docType.doc_type_id}">
				...
				<tr>
					...
					<td>
						<c:set var="form_type" value="${param.form_type}"/>
