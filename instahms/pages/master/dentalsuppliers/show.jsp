...
<script>
	...
	function keepBackUp(){
				backupName = document.dentalSupplierMaster.supplier_name.value;
	}
	...
	if(status.value == 'I') {
		for(var i=0;i<supplierItemsRateList.length;i++){
			...
			if (supplierId == item.supplier_id){
				alert(document.dentalSupplierMaster.supplier_name.value+" is being used in Dental Supplier Rate master ...");
			   	return false;
			}
		}
	}
...
<form action="update.htm" method="POST" name="dentalSupplierMaster">
	<input type="hidden" name="supplier_id" id="supplier_id" value="${bean.supplier_id}"/>

	<h1>Edit Dental Supplier</h1>
	...
	<fieldset class="fieldsetborder">
		...
		<table class="formtable">
			<tr>
				...
				<td>
					<input type="text" name="supplier_name" id="supplier_name" value="${bean.supplier_name}" maxlength="100"><span class="star">*</span>
				</td>
				...
				<td>
					<textarea name="supplier_address" cols="20" rows="2">${bean.supplier_address}</textarea>
				</td>
			</tr>
			<tr>
				<td class="formlabel">Supplier Phone1:</td>
				<td>
					<input type="text" name="supplier_phone1" id="supplier_phone1" value="${bean.supplier_phone1}" maxlength="20">
				</td>
				<td class="formlabel">Supplier Phone2:</td>
				<td>
					<input type="text" name="supplier_phone2" id="supplier_phone2" value="${bean.supplier_phone2}" maxlength="20">
				</td>
				<td class="formlabel">Supplier Fax:</td>
				<td>
					<input type="text" name="supplier_fax" id="supplier_fax" value="${bean.supplier_fax}" maxlength="20">
				</td>
			</tr>
			<tr>
				<td class="formlabel">Supplier Mail:</td>
				<td>
					<input type="text" name="supplier_mailid" id="supplier_mailid" value="${bean.supplier_mailid}" maxlength="100">
				</td>
				<td class="formlabel">Supplier Website:</td>
				<td>
					<input type="text" name="supplier_website" id="supplier_website" value="${bean.supplier_website}" maxlength="100">
				</td>
				<td class="formlabel">Contact Person Name:</td>
				<td>
					<input type="text" name="contact_person_name" id="contact_person_name" value="${bean.contact_person_name}" maxlength="100">
				</td>
			</tr>
			<tr>
				<td class="formlabel">Contact Person Mobile:</td>
				<td>
					<input type="text" name="contact_person_mobile_number" id="contact_person_mobile_number" value="${bean.contact_person_mobile_number}" maxlength="100">
				</td>
				<td class="formlabel">Contact Person Mail:</td>
				<td>
					<input type="text" name="contact_person_mailid" id="contact_person_mailid" value="${bean.contact_person_mailid}" maxlength="100">
				</td>
			</tr>
		</table>
