...
<head>
	...
	<script type="text/javascript">
		...
		var roleNameList = ${allRoleNames};
		var userNameList = ${allUserNames};

		function autoCompleteForRoles(){
			dataSource = new YAHOO.widget.DS_JSArray(roleNameList);
			oAutoComp = new YAHOO.widget.AutoComplete('user_role', 'roleContainer', dataSource);
		...
		function autoCompleteForUserNames(){
			...
			oAutoComp = new YAHOO.widget.AutoComplete('recipient_name', 'userContainer', dataSource);
			oAutoComp.maxResultsDisplayed = 18;
			oAutoComp.allowBrowserAutocomplete = false;
			oAutoComp.prehighlightClassName = "yui-ac-prehighlight";
			oAutoComp.typeAhead = false;
...
<body onload="autoCompleteForRoles();onLoadRecipientList();">
...
<div>&nbsp;</div>
<form action="Message.do" method="GET" name="userSearchForm">
		...
		<insta:search form="userSearchForm" optionsId="optionalFilter" closed="${results}" >
			<div class="searchBasicOpts">
				<div class="sboField">
					<div class="sboFieldLabel">User Name</div>
					<div class="sboFieldInput">
						<div id="autouser" class="autocomplete">
						<input type="text" id="recipient_name" name="recipient_name" value="${ifn:cleanHtmlAttribute(param.recipient_name)}"
							style="width:140px;"/>
				...
				<div class="sboField">
					<div class="sboFieldLabel">Role Name</div>
					<div class="sboFieldInput">
						<div id="autorole" class="autocomplete">
						<input type="text" id="user_role" name="user_role" value="${ifn:cleanHtmlAttribute(param.user_role)}"
							style="width:140px;"/>
							<input type="hidden" name="user_role@op" value="ilike"/>
				...
				<table class="searchFormTable">
					<tr>
						<td class="last">
							...
							<div class="sfField">
								<insta:checkgroup name="emp_status" opvalues="A,I" optexts="Active,Inactive" selValues="${paramValues.status}"/>
							</div>
						</td>
					</tr>
				</table>
	...
	<div class="resultList">
		...
		<table class="resultList dialog_displayColumns" cellpadding="0" cellspacing="0" align="center" width="100%" id="resultTable" >
			...
			<tr class="${status.index == 0 ?'firstRow': ''} ${status.index % 2 == 0? 'even':'odd' }">
					...
					<td><input type="checkbox" name="_selected_recipients" value="${recipientData.key}" ${checked} onclick="clickRecipient(this, '${recipientData.key}');"></td>
					<td>
