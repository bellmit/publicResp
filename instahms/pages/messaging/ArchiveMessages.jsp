...
<c:set var="searchUrl" value="${cpath}/message/ArchiveMessages.do?_method=list" />
<c:set var="detailsUrl" value="message/ArchiveMessages.do?_method=show" />
...
<div class="pageHeader">Archive Messages</div>
