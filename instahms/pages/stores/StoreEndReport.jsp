...
<head>
<title>Stores End-of-Day Report - Insta HMS</title>

</head>

<html>
	<body onload="setDateRangeYesterday(document.forms[0].fromDate, document.forms[0].toDate);">
		<div class="pageHeader">Stores End-of-Day Report</div>
		<form name="inputform" method="GET" target="_blank"	>
			...
			<div class="tipText">
				This report lists stockIssue,sales(all payment modes),net profit in the given time period.
			...
			<table align="center">
				<tr>
					<td colspan="2">
						...
						<input type="hidden" id="decimalplaces" name="decimalplaces" value="${prefDecimalDigits }"/>
					</td>
				</tr>
			</table>
