...
<html>
<head>
	<title><insta:ltext key="storemgmt.indentapprovallist.list.user.title"/></title>
	...
	var indentApprovalBy = '${indentApprovalBy}';
 	var gRoleId = '${roleId}';
	</script>
	...
	<insta:link type="script" file="stores/view_user_approval_indent.js"/>
...
<h1><insta:ltext key="storemgmt.indentapprovallist.list.user.indentapprovallist"/></h1>
...
<form name="indentApprovalSearchForm" method="GET">
	...
	<insta:search form="indentApprovalSearchForm" optionsId="optionalFilter" closed="${hasResults}" >
	  <div class="searchBasicOpts" >
	  	<div class="sboField">
			<div class="sboFieldLabel"><insta:ltext key="storemgmt.indentapprovallist.list.raisedbyuser.store"/></div>
			...
			<div class="sboFieldLabel"><insta:ltext key="storemgmt.indentapprovallist.list.indentno"/></div>
		  	...
		  	<div class="sboField">
		  		<div class="sboFieldLabel"><insta:ltext key="storemgmt.indentapprovallist.list.itemname"/></div>
				<div class="sfField">
					<div id="itemWrapper">
	  ...
	  <div id="optionalFilter" style="clear: both; display: ${hasResults ? 'none' : 'block'}" >
	  	<table class="searchFormTable">
			...
			<%-- 		<td>
						...
						<div class="sfField">
							<div id="itemWrapper">
								<input type="text" name="item_name" id="item_name" value="${param.item_name}"/>
								<div id="item_dropdown" class="scrolForContainer"></div>
							</div>
						</div>
					</td> --%>
					...
					<td>
						<div class="sfLabel"><insta:ltext key="storemgmt.indentapprovallist.list.requestingdepartment"/></div>
						<div class="sfField">
							<insta:selectdb  name="dept" value="${param.dept}" table="department"
							valuecol="dept_id" displaycol="dept_name" dummyvalue="${all}"
							orderby="dept_name"/>
						</div>
						<div class="sfLabel"><insta:ltext key="storemgmt.indentapprovallist.list.requestingward"/></div>
						<div class="sfField">
							<select name="ward" id="ward" class="dropdown">
								<option value=""><insta:ltext key="storemgmt.indentapprovallist.list.all.in.brackets"/></option>
								<c:forEach items="${wards }" var="ward">
									<option value="${ward.map.ward_no }"
										<c:if test="${param.ward eq ward.map.ward_no}"><insta:ltext key="storemgmt.pharmacyindentlist.add.selected"/></c:if> >
											${ward.map.ward_name }
									</option>
								</c:forEach>
							</select>
	...
	<div class="resultList">
		<table class="resultList" cellspacing="0" cellpadding="0" id="resultTable" onmouseover="hideToolBar('');">
			<tr onmouseover="hideToolBar();">
				...
				<th><insta:ltext key="storemgmt.indentapprovallist.list.dept.ward"/></th>
				<c:if test="${multiCentered && centerId == 0}">
