...
<head>
	<title>Services Prescription Ordered Report - Insta HMS</title>

</head>

<html>
	<body>
		<div class="pageHeader">Doctor Wise Services Prescription Ordered Report</div>
		<form name="inputform" method="GET" target="_blank"	action="ServicesPrescriptionOrderedReport.do">
			<input type="hidden" name="report" value="ServicesPrescriptionOrderedReport"/>
			<input type="hidden" name="method" value="getReport" />
			<div class="tipText">
				This report lists service prescriptions ordered by doctor wise in the given time period.
			</div>
