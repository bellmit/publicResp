...
<html>
	<body onload="onInit()">
		<div class="pageHeader">Test Count Report</div>
		<form name="inputform"  target="_blank"
		 method="GET" >
		<input type="hidden" name="method" value="getReport">
		<input type="hidden" name="patientType" value=""/>
		<div class="tipText">
				This report shows the number of tests conducted
				within given dates for the selected category,patient type and department.
		</div>
		...
		<div class="stwMain">
		<table width="100%" class="search" align="center">
			<tr>
			...
			<tr>
				<td>
					<button type="submit" accesskey="G"
						onclick="return validateCategory()"><b><u>G</u></b>eneratte Report</button>
				</td>
			</tr>
