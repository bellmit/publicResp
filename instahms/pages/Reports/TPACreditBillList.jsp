...
<html>
<head>
<title>TPA Credit Bill List- Insta HMS</title>
</head>
<body>
<div class="pageHeader">TPA /Sponsor Credit Bill List</div>
<form name="inputform" method="GET" target="_blank"	action="TPACreditBillList.do">
	<input type="hidden" name="report" value="TPACreditBillChart">
	<input type="hidden" name="method" value="getReport" />

	<table align="center">
				<tr>
					<td colspan="2">This report includes all Bill Later IP patients who are currently
active (ie, not discharged).</td>
<tr> </tr>
<tr> </tr>
				</tr>
				<tr>
