	...
	var name="";
	    ...
	    if(document.forms[0].type[0].checked){
	        if(validateForm()){
	            ...
	            var url="operationtheatrereport.do?method=getOperationCatReport&kor=OC&type=day&fromDate="+fromdate+"&toDate="+todate;
	            //alert(url);
	            window.open(url);
	            }
	         ...
	         //alert(mrno);
	        var url="operationtheatrereport.do?method=getOperationCatReport&kor=OC&type=mrno&mrno="+mrno;
	       // alert(url);
	        window.open(url);
	      ...
	      // alert(deptName);
	       var url="operationtheatrereport.do?method=getOperationCatReport&kor=OC&type=dept&dept="+dept+"&deptName="+deptName;
	        //alert(url);
	        window.open(url);
	        ...
	        // alert(name);
	        var url="operationtheatrereport.do?method=getOperationCatReport&kor=OC&type=name&name="+name;
	       // alert(url);
	        window.open(url);
	      }else{
...
<!-- Main tab--> <TABLE width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    <TR>
                      ...
                      <TD height="20" background="../../images/sub_img03.gif" class="subtitle" width="100%" align="center">Operation Conducted Report</TD>
