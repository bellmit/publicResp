...
<html>
<head>
<title>Death Report - Insta HMS</title>
</head>
<body>
<div class="pageHeader">Death Report</div>
<form name="inputform" method="GET" target="_blank"	action="DeathReport.do">
	<input type="hidden" name="report" value="death_report">
	<input type="hidden" name="method" value="getReport" />

	<table align="center">
				<tr>
					<td colspan="2">This report shows the  list of patients whose expired date between the selected date</td>
<tr> </tr>
<tr> </tr>
				</tr>
				<tr>
