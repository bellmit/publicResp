...
<head>
<title>Reagent/Consumable Summary Report- Insta HMS</title>
...
<html>
	<body>
		<div class="pageHeader">Reagent/Consumable Summary Report</div>
		<form name="inputform" method="GET" target="_blank" action="ReagentSummaryReport.do" >
			<input type="hidden" name="report" value="ReagentSummaryReport">
			<input type="hidden" name="method" value="getReport" />
			<div class="tipText">
				This report lists the total quantity of each reagent that has been used for test and test count
