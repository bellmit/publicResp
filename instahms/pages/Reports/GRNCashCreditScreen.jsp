...
<insta:link type="script" file="date_go.js"/>
	...
	if(method=="getInvGRNCashCreditStatement"){
			window.open("inventoryReport.do?&method="+method+"&fromDate="+fromDate+"&toDate="+toDate+"&type="+payType);
			document.forms[0].fromDate.value="";
			document.forms[0].toDate.value="";
			document.getElementById("payType").value="";
	}else{
			window.open("PharmacyReport.do?&method="+method+"&fromDate="+fromDate+"&toDate="+toDate+"&type="+payType);
			document.forms[0].fromDate.value="";
			document.forms[0].toDate.value="";
			document.getElementById("payType").value="";
	}
...
<FORM method="POST">
<input type="hidden" name="method" value="<%=com.insta.hms.common.Encoder.cleanJavaScript(request.getParameter("method"))%>"/>
...
<!-- Main tab--> <TABLE width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    <TR>
                      ...
                      <TD height="20"  class="pageHeader" width="100%" align="center"><%=com.insta.hms.common.Encoder.cleanJavaScript(request.getParameter("header"))%></TD>
                      <TD width="10" height="20"></TD>
                    </TR>
     ...
     <!-- Center tab-->    <TABLE width="100%" border="0" cellpadding="5" cellspacing="0" class="tabletext" height="100%">
                              ...
                              <tr width="100%" height="19">
                                     <td width="50%" align="right"><span style="font-family:Verdana; font-size:12px; color:#2a7d17">From</span>&nbsp;&nbsp;&nbsp;
                          			     <input type="text" name="fromDate" size="27" id="fdate" onclick="javascript:show_calendar('forms[0].fromDate');"  class="forminput" >&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                              ...
                              <tr width="100%" height="19"><td colspan="2">&nbsp;</td></tr>
                              <tr width="100%" height="19">
                                        <td align="center" colspan="2"><span style="font-family:Verdana; font-size:12px; color:#2a7d17">Payment Type</span>&nbsp;&nbsp;
                                           <select name="payType" id="payType" style="width:158" class="forminput" >
