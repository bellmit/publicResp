...
<html>
<head>
<title>PO Confirmation - Insta HMS</title>
...
<insta:link type="script" file="hmsvalidation.js"/>
	...
	var pono = document.getElementById('pono').options[document.getElementById('pono').options.selectedIndex].text;
	var total_amt =document.getElementById('pono').options[document.getElementById('pono').options.selectedIndex].value;
	//alert("total amount"+total_amt);
	window.open("PharmacyReport.do?&method=getPharmacyPOConfirmationdetails&poNo="+pono+"&total="+total_amt);
				document.forms[0].fromDate.value="";
				document.forms[0].toDate.value="";
				document.getElementById("pono").options[0].selected=true;
	}
	}
...
mon=12;
  ...
  function getPoNo(){
 		...
 		req.onreadystatechange = onResponse;
	  	var url="/HMSNew/pages/Enquiry/PharmacyReport.do?method=getPoConfirmationDetails&fromDate="+from_dt+"&toDate="+to_dt;
 ...
 function getPONo(){
 	...
 	var p=0;
 	document.forms[0].pono.length=len+1;
	document.forms[0].pono.options[0].value="";
//	document.forms[0].pono.options[0].selectedIndex=0;
 	document.forms[0].pono.options[0].text="...Select one...";

 	for(i=1;i<=len;i++){
 		document.forms[0].pono.options[i].value = x.childNodes[0].childNodes[i-1].attributes.getNamedItem('class2').nodeValue;
 		document.forms[0].pono.options[i].text = x.childNodes[0].childNodes[i-1].attributes.getNamedItem('class1').nodeValue;
 		p++;
 	}
 }
//end of ajax script
...
<!-- Main tab--> <TABLE width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
                    <TR>
                      ...
                      <TD height="20" background="../../images/sub_img03.gif" class="subtitle" width="100%" align="center">PO CONFIRMATION DETAILS</TD>
     ...
     <!-- Center tab-->    <TABLE width="100%" border="0" cellpadding="5" cellspacing="0" class="tabletext" height="100%">
                              ...
                              <tr width="100%" height="19">
                                     ...
                                     <td width="50%"><span style="font-family:Verdana; font-size:12px; color:#800000">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; To</span>&nbsp;&nbsp;&nbsp;
                          			     <input type="text" name="toDate" size="27" id="todate"  class="forminput" onblur="getPoNo();">&nbsp;<a href='javascript:show_calendar("forms[0].todate");' id='D'  ><insta:link type="image" file="show-calendar.gif"/></a></td></tr>
                              <tr width="100%" height="19"><td colspan="2">&nbsp;</td></tr>
                              <tr width="100%" height="19"><td colspan="2">&nbsp;</td></tr>
                              <tr width="100%" height="19">
                                        <td align="center" colspan="2"><span style="font-family:Verdana; font-size:12px; color:#800000">Purchase Order Number</span>&nbsp;&nbsp;
                                           <select name="pono" id="pono" style="width:100" class="forminput" >
