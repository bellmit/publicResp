...
<div align="center" style="font-size: 12pt;"><b>Operation Record</b></div>
...
<div>
		...
		<h3 style="margin-top: 10px"><u>Operation Details</u></h3>
			<table cellspacing='0' cellpadding='1' style='margin-top: 5px' width="100%">
				<tbody>
					<tr>
						<th width="45%">Procedure Name</th>
						<th width="15%">Surgery Type</th>
						<th width="40%">Modifier</th>
					</tr>
		...
		<!-- [#list opCompSectionValues?keys as opeProcId]
			...
			<!-- [#assign operationMap = opCompSectionValues[opeProcId]]  -->
				...
				<!-- [#list operationMap?keys as sectionDetailId]
						...
						<h3>${fieldTitle?html}
						<!--	[#if stn_title == fieldTitle] -->
							${'- ' + stn_count?html}
						<!--		[#assign stn_count = stn_count + 1] -->
						<!--	[/#if] -->
						<!--	[#if stn_title != fieldTitle] -->
						<!--		[#assign stn_count = 1] -->
						<!--		[#assign stn_title = fieldTitle] -->
						<!--	[/#if] -->
						</h3>
