 ...
 <div class="patientHeader">
	...
	<table style="margin-top: 10px; width:100%">
		<tr>
			...
			<th style="width : 4%">Strength</th>
			<th style="width : 4%">Dosage</th>
			<th style="width : 4%">Frequency</th>
			<th style="width : 10%">Start Date</th>
			<th style="width : 10%">End Date</th>
			<th style="width : 10%">Adm Date</th>
			<th style="width : 10%">Adm By</th>
			<th style="width : 20%">Activity Remarks</th>
		</tr>
	[#if medication_chart?has_content]
		[#list medication_chart as medicine]
			<tr>
			    <td>${medicine.medicine_name!}</td>
				<td>${medicine.doctor_name!}</td>
				<td>${medicine.med_strength!}</td>
				<td>${medicine.med_dosage!}</td>
				<td>${medicine.recurrence_name!}</td>
				<td>${medicine.start_datetime!}</td>
				<td>${medicine.end_datetime!}</td>
				<td>${medicine.completed_date}</td>
				<td>${medicine.completed_by}</td>
				<td>${medicine.activity_remarks!}</td>
			</tr>
		[/#list]
	[/#if]
	</table>
