	...
	<!-- [#if (d.valueTests??) && (d.valueTests?size>0) ] -->
			<tr style='border-bottom: 1px solid black;'>
				<!--[#if (d.hasRemarks == true)]
				 		[#assign width = {"Test Description":"25%","Result":"20%","Methodology":"9%","Units":"9%","Reference Range":"27%","Remarks":"20%"}]
				 		[#assign keys = width?keys]
				  	[#else]
						[#assign width = {"Test Description":"35%","Result":"20%","Methodology":"10%","Units":"10%","Reference Range":"35%"}]
						[#assign keys = width?keys]
			 	  	[/#if]-->
				<!--[#list keys as head] -->
...
<!-- [/#if] -->
 <!-- [#list amendedDepts as d] -->
	...
	<!-- [#if (d.valueTests??) && (d.valueTests?size>0) ] -->
			<tr style='border-bottom: 1px solid black;'>
				<!--[#if (d.hasRemarks == true)]
				 		[#assign width = {"Test Description":"30%","Result":"10%","Methodology":"10%","Units":"10%","Reference Range":"30%","Remarks":"20%","Amendment Reason":"30%"}]
				 		[#assign keys = width?keys]
				  	[#else]
						[#assign width = {"Test Description":"40%","Result":"10%","Methodology":"10%","Units":"10%","Reference Range":"40%","Amendment Reason":"30%"}]
						[#assign keys = width?keys]
			 	  	[/#if]-->
				<!--[#list keys as head] -->
						<th align='left' width='${width[head]}'>${head}</th>
