...
<div align="center" style="font-size: 12pt;"><b>IP Record</b></div>
...
<div>
	<!-- [#list ip_record_components.sections?split(",") as formid]
			[#if formid?number == -18 && patientNotes?has_content] -->
				...
				<!-- [#list patientNotes as note] -->	
					...
					<tbody>								
						<tr>
							<td width="35%" align="left">Date : ${note.created_time}</td>
						...
						<tr>
							<td colspan="3" align="left">${note.note_content}</td>
						</tr>
						<tr><td colspan="3">&nbsp;</td></tr>
					</tbody>
					</table>
				<!--  [/#list] -->
	<!--		[#elseif formid?number == -1 ] -->
...
<!-- 	[#elseif formid?number == -14 && antenatalinfo?has_content] -->
