...
<%@ attribute name="totalRecords" required="true"%>
<%@ attribute name="showRecordCount" required="false"%>
...
<div class = "pagination-wrapper">
	...
	<c:if test="${numPages > 0}">
		...
		<div class="fltR" style="display: ${empty showRecordCount or showRecordCount ? "inline" : 'none'}">${ifn:cleanHtml(totalRecords)} <insta:ltext key="paginate.records.found"/></div>
