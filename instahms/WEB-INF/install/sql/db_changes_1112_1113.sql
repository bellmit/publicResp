...
CREATE SEQUENCE vital_department_details_seq
	START WITH 1
	INCREMENT BY 1
	NO MINVALUE
	NO MAXVALUE
...
DROP TABLE IF EXISTS vital_department_details;
CREATE TABLE vital_department_details(
	vital_dept_id      	integer DEFAULT nextval('vital_department_details_seq'::regclass) PRIMARY KEY NOT NULL,
	vital_param_id      integer NOT NULL,
	department_id       varchar(10)
);

CREATE SEQUENCE vital_center_details_seq
	START WITH 1
	INCREMENT BY 1
	NO MINVALUE
	NO MAXVALUE
...
DROP TABLE IF EXISTS vital_center_details;
CREATE TABLE vital_center_details(
	vital_center_id      	integer DEFAULT nextval('vital_center_details_seq'::regclass) PRIMARY KEY NOT NULL,
	vital_param_id          integer NOT NULL,
