...
@Component
public class ZSCSegment extends InstaHl7Segment {
  ...
  public void getSegment(Message message, String messageVersion, Map<String, Object> dataMap,
    ...
    segmentTemplate = getSegmentTemplate("ZSC", messageVersion, (int) dataMap.get(INTERFACE_ID));
    if (validateSegmentData("ZSC", segmentTemplate, dataMap)) {
      addSegmentData((AbstractSegment) msg.get(msg.addNonstandardSegment("ZSC")), dataMap,
          segmentTemplate);
    }
  }
}
