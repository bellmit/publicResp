...
@Component
public class MSHSegment extends InstaHl7Segment {
  ...
  public void getSegment(Message message, String messageVersion, Map<String, Object> dataMap,
    ...
    segmentTemplate = getSegmentTemplate("MSH", messageVersion, (int) dataMap.get(INTERFACE_ID));
    addSegmentData((AbstractSegment) msg.get("MSH"), dataMap, segmentTemplate);
  }
}
