...
@Component
public class EVNSegment extends InstaHl7Segment {
  ...
  public void getSegment(Message message, String messageVersion, Map<String, Object> dataMap,
    ...
    segmentTemplate = getSegmentTemplate("EVN", messageVersion, (int) dataMap.get(INTERFACE_ID));
    addSegmentData((AbstractSegment) msg.get("EVN"), dataMap, segmentTemplate);
  }
}
