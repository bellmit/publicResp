...
public class PrescribingDrPaymentsForm extends ActionForm{


	private String prescribing_dr_id;
	...
	public String getPrescribing_dr_id() { return prescribing_dr_id; }
	public void setPrescribing_dr_id(String v) { prescribing_dr_id = v; }

	public String get_doctorName() { return _doctorName; }
	public void set_doctorName(String v) { _doctorName = v; }
