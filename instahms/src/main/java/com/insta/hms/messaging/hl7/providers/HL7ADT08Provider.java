...
/**
 * The Class HL7ADT08Provider.
 * 
 * @author yashwant
 */
public class HL7ADT08Provider extends HL7ADTProvider {

  /** The Constant logger. */
  private static final Logger logger = LoggerFactory.getLogger(HL7ADT08Provider.class);
  /** The Constant THIS_PROVIER. */
  private static final String THIS_PROVIER = "HL7_ADT_08_PROVIDER";

  /**
   * Instantiates a new HL 7 ADT 08 provider.
   */
  public HL7ADT08Provider() {
    super(THIS_PROVIER);
  ...
  public List<Map> getMessageDataList(MessageContext ctx) throws SQLException, ParseException {
    ...
    logger.info("####################################");
    logger.info("HL7_COMMUNICATION_INIT : Building ADT08 Message");
   ...
   */
  @SuppressWarnings({ "rawtypes", "unchecked" })
  private void createMSH(ADT_A08 adt, Map configParams) throws DataTypeException {
    Map<String, String> dataMap = new HashMap<>();
    dataMap.put("sending_application_namespace_id", "ADT08");
   ...
   *           the HL 7 exception
   */
  private void createPID(ADT_A08 adt, Map<String, Object> patientMap) throws HL7Exception {
    PID pid = adt.getPID();
   ...
   *           the data type exception
   */
  private void createEvn(ADT_A08 adt, Map<String, String> data) throws DataTypeException {
    EVN evn = adt.getEVN();
   ...
   *           the data type exception
   */
  private void createPV1(ADT_A08 adt, Map<String, Object> patientMap,
   ...
   *           the data type exception
   */
  private void createIN(ADT_A08 adt, Map<String, Object> patientMap) throws DataTypeException {
   ...
   *           the data type exception
   */
  private void createDG1(ADT_A08 adt, String patientId) throws DataTypeException {
    if (patientId == null) {
      return;
    }
   ...
   */
  @SuppressWarnings("unchecked")
  private void createAl1(ADT_A08 adt, String patientId) throws DataTypeException {
    if (patientId == null) {
      return;
    }
