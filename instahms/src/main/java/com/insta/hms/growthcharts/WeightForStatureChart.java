...
/**
 * The Class WeightForStatureChart.
 */
public class WeightForStatureChart extends AbstractGrowthCharts {
  ...
  /**
   * Instantiates a new weight for stature chart.
   *
   * @param chartType the chart type
   * @param growthChartDescBean the growth chart desc bean
   */
  public WeightForStatureChart(String chartType, BasicDynaBean growthChartDescBean) {
   ...
   * @param chartType the chart type
   */
  public WeightForStatureChart(BasicDynaBean growthChartDescBean, String chartRange,
      String chartType) {
      ...
      if (null != chartType && !chartType.equals("")) {
        ...
        for (String per : percentailList) {
          ...
          for (BasicDynaBean referenceData : referenceDataList) {
            ...
            refSeries.add(Double.parseDouble(referenceData.get("stature").toString()),
  ...
  private static JFreeChart createChart(BasicDynaBean patientDetails, XYDataset referenceDataSet,
    ...
    JFreeChart chart = null;
    chart =
        ChartFactory.createXYLineChart(header, "Stature (cm)", "", null, PlotOrientation.VERTICAL,
            false, true, false);
