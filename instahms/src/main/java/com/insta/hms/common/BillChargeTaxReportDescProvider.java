...
/**
 * The Class BillChargeTaxReportDescProvider.
 */
public class BillChargeTaxReportDescProvider extends StdReportDescJsonProvider {
  ...
  public Map<String, Field> addTaxCustomFields() throws SQLException {
    ...
    fields.putAll(ReportCustomFieldsHelper.addBillItemTaxRateCustomFieldsByCharge());
    fields.putAll(ReportCustomFieldsHelper.addBillTaxSubGroupCustomFieldsByCharge());
    return fields;
  }
