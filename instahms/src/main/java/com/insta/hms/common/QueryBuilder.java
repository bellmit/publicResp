...
/*
 * Base class for SearchQueryBuilder and ReportQueryBuilder: containing all the
 * common methods/utilities used in both:
...
public class QueryBuilder {
   ...
   */
  public QueryBuilder(String initWhere) {
  ...
  public void addFilterFromString(String typeStr, String field, String op, String value,
      boolean doCast) throws ParseException, SQLException {
    ...
    if (op.equals("null")) {
      ...
      java.sql.Date[] dateRange = DateUtil.getDateRange(value);
  ...
  public void addFilterFromString(String typeStr, String field, String op, String[] values,
      boolean doCast) throws ParseException {
   ...
   * @throws ParseException the parse exception
   */
  public static Object parseString(int type, String value) throws ParseException {
    switch (type) {
      case STRING:
        return value;
      case INTEGER:
   ...
   * @throws SQLException the SQL exception
   */
  public static void setTypeInStatement(PreparedStatement stmt, int sindex, int type, Object value)
      throws SQLException {
    switch (type) {
      case INTEGER:
        stmt.setInt(sindex, (Integer) value);
        break;
      case STRING:
        stmt.setString(sindex, (String) value);
        break;
      case NUMERIC:
        stmt.setBigDecimal(sindex, (BigDecimal) value);
        break;
      case DATE:
        stmt.setDate(sindex, (java.sql.Date) value);
        break;
      case TIMESTAMP:
        stmt.setTimestamp(sindex, (java.sql.Timestamp) value);
        break;
      case TIME:
        stmt.setTime(sindex, (java.sql.Time) value);
        break;
      case BOOLEAN:
        stmt.setBoolean(sindex, (Boolean) value);
        break;
      default:
        break;
    }
