...
/**
 * The Class ItemSubgroupTaxDetailsValidator.
 *
 * @author irshadmohammed
 */
@Component
public class ItemSubgroupTaxDetailsValidator extends MasterValidator {

  /** The Constant NOT_NULL_FIELDS_INSERT. */
  private static final String[] NOT_NULL_FIELDS_INSERT = new String[] { "validity_start" };
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE = new String[] { "item_subgroup_id",
      "validity_start" };
  ...
  /**
   * Instantiates a new item subgroup tax details validator.
   */
  public ItemSubgroupTaxDetailsValidator() {
    super();
