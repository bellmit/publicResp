 ...
 */
@Component
public class CountryValidator extends MasterValidator {

  /** The Constant NOT_NULL_FIELDS_INSERT. */
  private static final String[] NOT_NULL_FIELDS_INSERT = new String[] { "country_name", "status" };
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE = new String[] { "country_id",
      "country_name", "status" };
