...
/** The Class InsAggregatorCentersValidator. */
@Component
public class InsAggregatorCentersValidator extends MasterValidator {

  /** The Constant NOT_NULL_FIELDS_INSERT. */
  private static final String[] NOT_NULL_FIELDS_INSERT =
      new String[] {"ia_id", "center_id", "facility_id"};
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE = new String[] {"ia_id", "center_id"};

  /** The Constant NOT_NULL_RULE_UPDATE. */
  private static final ValidationRule NOT_NULL_RULE_UPDATE = new NotNullRule();

  /** Instantiates a new ins aggregator centers validator. */
  public InsAggregatorCentersValidator() {
    super();
