...
/**
 * The Class ReceiptNumberSequenceValidator.
 */
@Component
public class ReceiptNumberSequenceValidator extends SequenceMasterValidator {

  /** The receipt number sequence service. */
  @LazyAutowired ReceiptNumberSequenceService receiptNumberSequenceService;
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE =
      new String[] {"receipt_number_seq_id", "pattern_id", "priority"};

  /**
   * Instantiates a new receipt number sequence validator.
   */
  public ReceiptNumberSequenceValidator() {
    super();
  ...
  public List<BasicDynaBean> getRuleList(BasicDynaBean bean) {
    return receiptNumberSequenceService.getConfictRules(bean);
  }
}
