...
/**
 * The Class BillSequenceValidator.
 */
@Component
public class BillSequenceValidator extends SequenceMasterValidator {
  
  /** The bill sequence service. */
  @LazyAutowired BillSequenceService billSequenceService;
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE =
      new String[] {"bill_seq_id", "pattern_id", "priority"};

  /**
   * Instantiates a new bill sequence validator.
   */
  public BillSequenceValidator() {
    super();
    super.errorsKey = "Bill Number Sequence";
  ...
  public List<BasicDynaBean> getRuleList(BasicDynaBean bean) {
    return billSequenceService.getConfictRules(bean);
  }
}
