...
/**
 * The Class VisitIdSequenceValidator.
 */
@Component
public class VisitIdSequenceValidator extends SequenceMasterValidator {
  
  /** The visit id sequence service. */
  @LazyAutowired VisitIdSequenceService visitIdSequenceService;
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE =
      new String[] {"visit_seq_id", "pattern_id", "priority"};

  /**
   * Instantiates a new visit id sequence validator.
   */
  public VisitIdSequenceValidator() {
    super();
    super.errorsKey = "Visit Id Sequence";
  ...
  public List<BasicDynaBean> getRuleList(BasicDynaBean bean) {
    return visitIdSequenceService.getConfictRules(bean);
  }
}
