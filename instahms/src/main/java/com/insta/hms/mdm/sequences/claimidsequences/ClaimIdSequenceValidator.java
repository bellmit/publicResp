...
/**
 * The Class ClaimIdSequenceValidator.
 */
@Component
public class ClaimIdSequenceValidator extends SequenceMasterValidator {
  
  /** The claim id sequence service. */
  @LazyAutowired ClaimIdSequenceService claimIdSequenceService;
  ...
  private static final String[] NOT_NULL_FIELDS_UPDATE =
      new String[] {"claim_seq_id", "pattern_id", "priority"};

  /**
   * Instantiates a new claim id sequence validator.
   */
  public ClaimIdSequenceValidator() {
    super();
    super.errorsKey = "Claim Id Sequence";
  ...
  public List<BasicDynaBean> getRuleList(BasicDynaBean bean) {
    return claimIdSequenceService.getConfictRules(bean);
  }
}
