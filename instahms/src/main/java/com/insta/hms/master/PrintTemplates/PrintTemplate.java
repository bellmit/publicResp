...
public enum PrintTemplate {
	...
	/*
	 * list of all customizable print templates available in hms.
	 * when adding new customizable print template to this list
	 * do not forget to insert the default row in db with template_type.
	 * then only newly added template will be available for user to customize it.
	 *
	 */
	...
	RegBarCode		("REGBARCODE", "RegistrationBarCodeTextTemplate", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	SamBarCode		("SAMBARCODE", "SampleCollectionBarCodeTextTemplate", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	...
	Patient_Ward_Activities  ("PWACT", "PatientWardActivities", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	View_Raise_Indent_print ("INDENT","VieworRaiseIndentPrint", PrintConfigurationsDAO.PRINT_TYPE_STORE),
	...
	Items_Return_Note_Print ("RETURNNOTE", "ItemsReturnNotePrint", PrintConfigurationsDAO.PRINT_TYPE_STORE),
	...
	Initial_Assessment ("Assessment", "InitialAssessmentPrint", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	...
	PATIENT_SURVEY_RESPONSE           	("PATIENT_RESPONSE_PRINT", "PatientResponsePrint", PrintConfigurationsDAO.PRINT_TYPE_PATIENT_SURVEY_RESPONSE),
	Sample ("PAPERPRINT", "SampleCollectionPaperPrint", PrintConfigurationsDAO.PRINT_TYPE_SAMPLE_COLLECTION),
	TRMT_QUOTATION ("TRMT_QUOTATION", "DentalTreatmentQuotationPrint", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	DENTAL_SUPPLIER_PRINT ("DENTAL_SUPPLIER_PRINT", "DentalSupplierPrint", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	...
	VisitSummaryRecord  ("VisitSummaryRecord", "VisitSummaryRecordsReport", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	ConsultationDetails ("ConsultationDetails", "ConsultationDetails", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	...
	PENDING_PRESCRIPTION ("PENDING_PRESC", "PendingPrescriptions", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	Medication_Chart("Medication_Chart", "MedicationChartReport", PrintConfigurationsDAO.PRINT_TYPE_PATIENT),
	PatientIssuePrintTemplate ("PatientIssuePrintTemplate", "PatientIssuePrintTemplate", PrintConfigurationsDAO.PRINT_TYPE_STORE),
	PatientIssueReturnPrintTemplate("PatientIssueReturnPrintTemplate","PatientIssueReturnPrintTemplate",PrintConfigurationsDAO.PRINT_TYPE_STORE),
	...
	PriorAuthPrescription ("PriorAuth", "EAuthPrescriptionPrint" ,PrintConfigurationsDAO.PRINT_TYPE_BILL),
	UserIssuePrintTemplate ("UserIssuePrintTemplate", "UserIssuePrintTemplate", PrintConfigurationsDAO.PRINT_TYPE_STORE),
	UserIssueReturnPrintTemplate("UserIssueReturnPrintTemplate","UserIssueReturnPrintTemplate",PrintConfigurationsDAO.PRINT_TYPE_STORE),
	WorkOrderPrintTemplate ("WorkOrderPrintTemplate", "WorkOrderPrintTemplate", PrintConfigurationsDAO.PRINT_TYPE_STORE),
	Discharge_Medication ("Discharge_Medication", "DischargeMedication", PrintConfigurationsDAO.PRINT_TYPE_DISCHARGE),
	Investigation ("Investigation", "InvestigationTemplate", PrintConfigurationsDAO.PRINT_TYPE_DISCHARGE),	
