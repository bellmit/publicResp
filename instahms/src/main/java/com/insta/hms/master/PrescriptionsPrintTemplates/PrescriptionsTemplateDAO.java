...
public class PrescriptionsTemplateDAO extends GenericDAO{
	public static final String table = "prescription_print_template";
	public PrescriptionsTemplateDAO() {
		super(table);
	}
	...
	private static final String TEMPLATE_CONTENT = "Select prescription_template_content,template_mode From " + table + " WHERE template_name = ?";
