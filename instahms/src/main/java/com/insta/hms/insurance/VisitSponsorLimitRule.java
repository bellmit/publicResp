...
/**
 * The Class VisitSponsorLimitRule.
 */
public class VisitSponsorLimitRule implements VisitInsuranceRule {

  /** The rt. */
  private RuleAdjustmentType rt = RuleAdjustmentType.VISIT_SPONSOR_LIMIT_ADJ;
  ...
  public boolean apply(List<BasicDynaBean> billCharges, Map<String, BasicDynaBean> billChargeClaims,
    ...
    BigDecimal visitSponsorLimit = null == visitInsurancePlan.get("visit_limit") ? BigDecimal.ZERO
        : (BigDecimal) visitInsurancePlan.get("visit_limit");
