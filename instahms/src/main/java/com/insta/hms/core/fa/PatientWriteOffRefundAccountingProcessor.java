...
/**
 * The Class PatientWriteOffRefundAccountingProcessor.
 */
@Component
public class PatientWriteOffRefundAccountingProcessor extends AbstractReceiptsAccounting {
  ...
  public List<HmsAccountingInfoModel> processAccountingForReceipt(ReceiptModel receipt) {
    ...
    receiptAccountingData.setNetAmount(receipt.getAmount().abs());
    ...
    receiptAccountingData.setPrimaryIdReferenceTable(ReceiptModel.class.getAnnotation(Table.class)
        .name());
    receiptAccountingData.setVoucherSubType(accountingDataInsertRepo.getVoucherDefinition("VOUCHER_SUB_TYPE_PATIENT_WRITEOFF_REFUND"));
