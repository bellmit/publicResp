...
/**
 * The Class InventoryReturnsAccountingDataInsertService.
 */
@Service
public class InventoryReturnsAccountingDataInsertService {
  ...
  public List<HmsAccountingInfoModel> getAccountingDataForInventoryItem(BillChargeModel charge,
    ...
    StoreIssueReturnsDetailsModel storeIssueReturnsDetailsModel = 
          (StoreIssueReturnsDetailsModel) accountingDataInsertRepo
            .load(StoreIssueReturnsDetailsModel.class, itemIssueId);
    if (storeIssueReturnsDetailsModel == null) {
      return new ArrayList<>();
    }
    StoreItemDetailsModel storeItemDetails = storeIssueReturnsDetailsModel.getStoreItemDetails();
    HmsAccountingInfoModel inventoryReturnItemDetails = setInventoryItemCommonData(
        storeIssueReturnsDetailsModel, storeItemDetails, accountingChargeDetails);
    ...
    if (!billModel.getIsTpa()) {
      HmsAccountingInfoModel patientAmountEntry = getPatientAmountAccountingEntry(charge,
          storeItemDetails, inventoryReturnItemDetails);
      ...
      List<HmsAccountingInfoModel> patientTaxEntries = getPatientTaxAmountAccountingEntries(
          billChargeTaxes, inventoryReturnItemDetails);
      ...
      HmsAccountingInfoModel itemCostValueEntry = getCostAccountingForInventoryReturnItem(
          storeIssueReturnsDetailsModel, inventoryReturnItemDetails);
    ...
    for (BillChargeClaimModel chargeClaim : billChargeClaims) {
      ...
      HmsAccountingInfoModel claimEntry = getClaimAmountAccountingEntries(chargeClaim,
          inventoryReturnItemDetails, charge, storeItemDetails);
      if (claimEntry != null) {
      ...
      List<HmsAccountingInfoModel> claimTaxEntries = getClaimTaxAmountAccountingEntries(
          billChargeClaimTaxes, inventoryReturnItemDetails, chargeTaxIdClaimTaxMap);
    ...
    List<HmsAccountingInfoModel> patientTaxEntries = getInsurancePatientTaxAmountAccountingEntry(
        billChargeTaxes, inventoryReturnItemDetails, chargeTaxIdClaimTaxMap);
    if (patientTaxEntries != null && !patientTaxEntries.isEmpty()) {
      accountingDataList.addAll(patientTaxEntries);
    }
   ...
   * @param charge
   *          the charge
   * @param storeItemDetails
   *          the store item details
  ...
  private HmsAccountingInfoModel getPatientAmountAccountingEntry(BillChargeModel charge,
    ...
    if (charge.getAmount().compareTo(BigDecimal.ZERO) != 0) {
      ...
      patientAmountEntry.setVoucherSubType(accountingDataInsertRepo.getVoucherDefinition("VOUCHER_SUB_TYPE_PATIENT_ISSUE_RETURN"));
  ...
  private List<HmsAccountingInfoModel> getPatientTaxAmountAccountingEntries(
    ...
    for (BillChargeTaxModel bcTax : billChargeTaxes) {
      ...
      patientTaxEntry.setVoucherSubType(accountingDataInsertRepo.getVoucherDefinition("VOUCHER_SUB_TYPE_PATIENT_ISSUE_RETURN"));
  ...
  /**
   * Gets the cost accounting for inventory return item.
   *
   * @param stockIssueDetailsModel
   *          the stock issue details model
   * @param inventoryItemDetails
   *          the inventory item details
   * @return the cost accounting for inventory return item
   */
  private HmsAccountingInfoModel getCostAccountingForInventoryReturnItem(
      StoreIssueReturnsDetailsModel stockIssueDetailsModel,
      HmsAccountingInfoModel inventoryItemDetails) {
    ...
    costValueEntry.setVoucherSubType(accountingDataInsertRepo.getVoucherDefinition("VOUCHER_SUB_TYPE_PATIENT_ISSUE_RETURN"));
   ...
   *
   * @param storeIssueReturnsDetailsModel
   *          the store issue returns details model
   * @param storeItemDetails
   *          the store item details
   * @param accountingChargeDetails
   *          the accounting charge details
  ...
  private HmsAccountingInfoModel setInventoryItemCommonData(
      StoreIssueReturnsDetailsModel storeIssueReturnsDetailsModel,
      StoreItemDetailsModel storeItemDetails, HmsAccountingInfoModel accountingChargeDetails) {
    ...
    inventoryItemDetails.setPrimaryId(String.valueOf(storeIssueReturnsDetailsModel
        .getItemReturnNo()));
    inventoryItemDetails.setPrimaryIdReferenceTable(StoreIssueReturnsDetailsModel.class
        .getAnnotation(Table.class).name());
    inventoryItemDetails.setSalesVatAmount(BigDecimal.ZERO);
    inventoryItemDetails.setSalesVatPercent(BigDecimal.ZERO);
    ...
    inventoryItemDetails.setQuantity(storeIssueReturnsDetailsModel.getQty());
    inventoryItemDetails.setIssueStore(getIssueStore(storeIssueReturnsDetailsModel));
    inventoryItemDetails
        .setIssueStoreCenter(getIssueStoreCenterName(storeIssueReturnsDetailsModel));
    ...
    inventoryItemDetails.setTaxAmount(BigDecimal.ZERO);
    inventoryItemDetails
        .setCostAmount(storeIssueReturnsDetailsModel.getCostValue() == null ? BigDecimal.ZERO
            : storeIssueReturnsDetailsModel.getCostValue());
   ...
   */
  private String getIssueStoreCenterName(
        StoreIssueReturnsDetailsModel storeIssueReturnsDetailsModel) {
    if (storeIssueReturnsDetailsModel != null
        && storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel() != null
        && storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel().getStoresModel() != null
        && storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel().getStoresModel()
            .getCenterId() != null) {
      return storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel().getStoresModel()
   ...
   */
  private String getIssueStore(StoreIssueReturnsDetailsModel storeIssueReturnsDetailsModel) {
    if (storeIssueReturnsDetailsModel != null
        && storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel() != null
        && storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel().getStoresModel() != null) {
      return storeIssueReturnsDetailsModel.getStoreIssueReturnsMainModel().getStoresModel()
