...
/**
 * The Class PatientWriteOffAccountingProcessor.
 */
@Component
public class PatientWriteOffAccountingProcessor extends AbstractReceiptsAccounting {
  ...
  public List<HmsAccountingInfoModel> processAccountingForReceipt(ReceiptModel receipt) {
    ...
    receiptAccountingData.setVoucherSubType(accountingDataInsertRepo.getVoucherDefinition("VOUCHER_SUB_TYPE_PATIENT_WRITEOFF"));
