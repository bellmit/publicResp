...
@Component
public class VATPurchaseTaxCalculator extends PurchaseTaxCalculator {

	@LazyAutowired
	TaxSubGroupService taxSubGroupService;

	private static final String[] SUPPORTED_GROUPS = new String[]{"VAT", "KSACTA", "KSACEX"};
	public VATPurchaseTaxCalculator() {
	...
	public Map<Integer, Object> calculateTaxes(ItemTaxDetails taxBean,
		...
		taxBean.setAdjMrp(/*taxBean.getCostPrice()*/ adjMrp);
