...
public class Estimate {
   ...
   *          Price precision of the estimate.
   */
   ...
   * 
   * @param templateName
   *          Name of the pdf template associated with the estimate.
   */
   ...
   *          Last modified time of the estimate.
   */
   ...
   *          Billing address of an estimate.
   * @throws Exception
   *           the exception
   */
   ...
   *          Shipping address of an estimate.
   * @throws Exception
   *           the exception
   */
   ...
   *          True or false to set the estimate is viewed by client.
   */
   ...
   *          Estimate viewed time by the client.
   */
   ...
   *          True or false to set the estimate allows the partial payments or not.
   */
   ...
   * 
   * @param acceptRetainer
   *          True or false to set the estimate is accept retainer or not.
   */
   ...
   *          Tax authority id for US edition.
   */
   ...
   *          Tax exemption id for US Edition.
   */
