...
public class Preference {
   ...
   * 
   * @param convertToInvoice
   *          To automatically convert accepted estimate to invoice.
   */
   ...
   * 
   * @param notifyMeOnOnlinePayment
   *          To get notified when customers pay online.
   */
   ...
   * 
   * @param sendPaymentReceiptAcknowledgement
   *          To automate thank you note to customer on receipt of online payment.
   */
   ...
   * 
   * @return Returns true if you get automate thank you note to customer on receipt of online
   *         payment else returns false.
   */
   ...
   * 
   * @param autoNotifyRecurringInvoice
   *          To determine whether to send recurring invoices directly to the customer.
   */
   ...
   * 
   * @return Returns true if the recurring invoices directly send to the customer else returns
   *         false.
   */
   ...
   * 
   * @param snailMailIncludePaymentStub
   *          To include payment stub and return envelope in snail mails.
   */
   ...
   * 
   * @param isShowPoweredBy
   *          To keep Zoho branding on your invoices and estimates.
   */
   ...
   *          To associate and display unbilled expense receipts in Invoice PDF.
   */
   ...
   * 
   * @param allowAutoCategorize
   *          To alow auto categorize the invoice.
   */
   ...
   *
   * @param autoReminders
   *          Auto reminders for the payments.
   * @throws Exception
   *           the exception
   */
