...
package com.insta.hms.extension.accounting.zoho.books.api;

import com.insta.hms.extension.accounting.zoho.books.model.Address;
import com.insta.hms.extension.accounting.zoho.books.model.ApplyCreditnote;
...
import com.insta.hms.extension.accounting.zoho.books.model.Contact;
import com.insta.hms.extension.accounting.zoho.books.model.Credit;
import com.insta.hms.extension.accounting.zoho.books.model.CreditList;
import com.insta.hms.extension.accounting.zoho.books.model.Email;
import com.insta.hms.extension.accounting.zoho.books.model.Invoice;
import com.insta.hms.extension.accounting.zoho.books.model.InvoiceList;
import com.insta.hms.extension.accounting.zoho.books.model.InvoicePayment;
import com.insta.hms.extension.accounting.zoho.books.model.LineItem;
import com.insta.hms.extension.accounting.zoho.books.model.PaymentList;
import com.insta.hms.extension.accounting.zoho.books.model.TemplateList;
import com.insta.hms.extension.accounting.zoho.books.parser.InvoiceParser;
import com.insta.hms.extension.accounting.zoho.books.util.ZohoHTTPClient;
 ...
 * The list of comments for an invoice.<br>
 * <br>
 * It is used to update:<br>
 * <br>
 * The details of an invoice.<br>
 ...
 * The comment of an invoice.<br>
 * <br>
 * It is used to change the status:<br>
 * <br>
...
public class InvoicesApi extends API {
   ...
   * <td>Search invoices by invoice number.<br>
   * Variants: <i>invoice_number_startswith</i> and <i>invoice_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_name</td>
   * <td>Search invoices by item name.<br>
   * Variants: <i>item_name_startswith</i> and <i>item_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_id</td>
   * <td>Search invoices by item id.</td>
   * </tr>
   * <tr>
   * <td>item_description</td>
   * <td>Search invoices by item description.<br>
   * Variants: <i>item_description_startswith</i> and <i>item_description_contains</i></td>
   * </tr>
   * <tr>
   * <td>reference_number</td>
   * <td>Search invoices by invoice reference number (i.e., P.O.#).<br>
   * Variants: <i>reference_number_startswith</i> and <i>reference_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_name</td>
   * <td>Search invoices by customer name.<br>
   * Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>recurring_invoice_id</td>
   * <td>Search invoices by recurring profile id.</td>
   * </tr>
   * <tr>
   * <td>email</td>
   * <td>Search invoices by customer contact persons email.</td>
   * </tr>
   * <tr>
   * <td>total</td>
   * <td>Search invoices by invoice total.<br>
   * Variants: <i>total_less_than, total_less_equals, total_greater_than</i> and
   * <i>total_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>balance</td>
   * <td>Search invoices by invoice total.<br>
   * Variants: <i>balance_less_than, balance_less_equals, balance_greater_than</i> and
   * <i>balance_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search invoices by invoice date.<br>
   * Variants: <i>date_start, date_end, date_before</i> and <i>date_after</i></td>
   * </tr>
   * <tr>
   * <td>due_date</td>
   * <td>Search invoices by due date.<br>
   * Variants: <i>due_date_start, due_date_end, due_date_before</i> and <i>due_date_after</i></td>
   * </tr>
   * <tr>
   * <td>status</td>
   * <td>Search invoices by invoice status.<br>
   * Allowed Values: <i>sent, draft, overdue, paid, void, unpaid, partiallypaid</i> and
   * <i>viewed</i></td>
   * </tr>
   * <tr>
   * <td>customer_id</td>
   * <td>Search invoices by customer id.</td>
   * </tr>
   * <tr>
   * <td>custom_field</td>
   * <td>Search invoices by custom fields.<br>
   * Variants: <i>custom_field_startswith</i> and <i>custom_field_contains</i></td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search invoices by invoice number or purchase order or customer name.</td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter invoices by any status or payment expected date.<br>
   * Allowed Values: <i>Status.All, Status.Sent, Status.Draft, Status.OverDue, Status.Paid,
   * Status.Void, Status.Unpaid, Status.PartiallyPaid, Status.Viewed</i> and
   * <i>Date.PaymentExpectedDate</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort invoices.<br>
   * Allowed Values: <i>customer_name, invoice_number, date, due_date, total, balance</i> and
   * <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   * @param queryMap
   *          It contains the query string parameters in the form of key-value pair.
   ...
   *
   * @param customerId
   *          ID of the customer for whom the invoice has to be created.
   * @param contactPersonId
   *          ID of the contact person for whom invoice has to be sent.
   * @param description
  ...
  public Invoice create(String customerId, String contactPersonId, String description)
      throws Exception {
   ...
   * The possible keys and values are mentioned below:<br>
   * <br>
   * send - Send the invoice to the contact person(s) associated with the invoice. Allowed Values:
   * true and false <br>
   * ignore_auto_number_generation - Ignore auto invoice number generation for this invoice. This
   * mandates the invoice number. Allowed Values: true and false <br>
   * <br>
   * The Invoice object which contains customerId, contactPersonId, and description are the
   ...
   *          Invoice object.
   * @param paramMap
   *          It contains the parameter values in the form of key-value pair.
   * @return Returns the Invoice object.
   * @throws Exception
   *           the exception
   */
   ...
   * Pass the Invoice object and query string parameters to update the details of a particular
   * invoice.
   * The possible key and value are mentioned below: <br>
   * <br>
   * ignore_auto_number_generation - Ignore auto estimate number generation for this estimate. This
   * mandates the estimate number.<br>
   * The Invoice object which contains invoiceId is the mandatory paramter for which invoice has to
   * be updated.
   * It returns the Invoice object.
   *
   * @param newInvoice
  ...
  /**
   * Delete an existing invoice (Invoices which have payment or credit notes applied cannot be
   * deleted).
  ...
  /**
   * Email an invoice to the customer (If the Email object is not inputted, mail will be send with
   * default mail content).
   * Pass the invoiceId, Email object, and query string paramters 
   * to send the email to the customer.
   * The possible keys and values are mentioned below: <br>
   * <br>
   * send_customer_statement - Send customer statement pdf a with email.<br>
   * send_attachment - Send the invoice attachment a with the email.<br>
   * <br>
   ...
   *          ID of an Invoice.
   * @param email
   *          Email object which contains an email content.
   * @param paramMap
   *          It contains the parameter values in the form of key-value pair.
   * @return Returns a String.
   * @throws Exception
  ...
  public String sendEmail(String invoiceId, Email email, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * The paramMap contains the possible key as mentioned below: <br>
   * <br>
   * invoice_ids* - Comma separated invoice ids which are to be emailed. <br>
   * <br>
  ...
  public String sendEmailInvoices(List<Contact> contacts, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * The queryMap contains the possible key as mentioned below: <br>
   * <br>
   * email_template_id - Get the email content based on a specific email template. <br>
   * <br>
   ...
   *          Id of an Invoice.
   * @param queryMap
   *          Get the email content based on a specific email template.
   * @return Returns an Email object which contains the email content.
   * @throws Exception
   *           the exception
   */

  public Email getEmailContent(String invoiceId, 
      HashMap<String, Object> queryMap) throws Exception {
  ...
  /**
   * Remind your customer about an unpaid invoice by email (Reminder will be sent, only for the
   * invoices which are in open or overdue status).
   * Pass the invoiceId, Email object, and query string parameters to send the reminder to the
   * customer.
   * The paramMap contains the possible key and value as mentioned below: <br>
   * <br>
   * send_customer_statement - Send customer statement pdf a with payment reminder. <br>
   * <br>
   ...
   *          ID of an Invoice.
   * @param email
   *          Email Object which contains email content.
   * @param paramMap
   *          It contains the parameter values in the form of key-value pair.
   * @return Returns a String.
   * @throws Exception
  ...
  public String sendPaymentReminder(String invoiceId, 
      Email email, HashMap<String, Object> paramMap)
      throws Exception {
  ...
  /**
   * Remind your customer about an unpaid invoices by email (Reminder mail will be sent, only for
   * the invoices which are in open or overdue status. The customer can be reminded for maximum 10
   * invoices at once.)
   * Pass the query string parameters to send the reminder to the customer.
   * The paramMap contains the possible key as mentioned below: <br>
   * <br>
   * invoice_ids* - Comma separated invoice ids which the reminder has to be sent.<br>
   * <br>
   * If the reminder has been sent to the customer it returns the success message.
   * The success message is "Success! All reminders have been sent."
   *
   * @param paramMap
   *          Comma separated invoice ids for which the reminder has to be sent.
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */
  ...
  /**
   * Mark an invoice status as void (Upon void, the payments and credits associated with the
   * invoices will be unassociated and will be under customer credits).
   ...
   * The queryMap contains the possible key as mentioned below: <br>
   * <br>
   * invoice_ids* - Comma separated invoice ids which are to be export as pdf.<br>
   * <br>
   * It returns a File object.
   *
   * @param queryMap
   *          Comma separated invoice ids which are to be exported as pdf.
   ...
   * The queryMap contains the possible key as mentioned below: <br>
   * <br>
   * invoice_ids* - Comma separated invoice ids which are to be printed.<br>
   * <br>
   * It returns a File object.
   *
   * @param queryMap
   ...
   * (You can set this address as default billing
   * address for your customer by specifying 'is_update_customer' param as true)
  ...
  public String updateBillingAddress(String invoiceId, Address billingAddress) throws Exception {
    ...
    requestBody.put("JSONString",
        billingAddress.toJSON().put("is_update_customer", billingAddress.isUpdateCustomer())
            .toString());
  ...
  /**
   * Updates the shipping address for this invoice (You can set this address as default shipping
   * address for your customer by specifying 'is_update_customer' param as true).
  ...
  public String updateShippingAddress(String invoiceId, Address shippingAddress) throws Exception {
    ...
    requestBody.put("JSONString",
        shippingAddress.toJSON().put("is_update_customer", shippingAddress.isUpdateCustomer())
            .toString());
   ...
   *          ID of an Invoice.
   * @param templateId
   *          ID of the template associated with an Invoice.
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */
  ...
  /**
   * Apply the customer credits either from credit notes or excess customer payments to an invoice
   * (Multiple credits can be applied at once).
   * Pass the invoiceId, list of InvoicePayment objects, and list of ApplyCreditnote objects to add
   * the credits for an invoice.
   * It returns the Credit object.
   *
   * @param invoiceId
   *          ID of an Invoice.
   * @param invoicePayments
   *          List of InvoicePayment object.
   * @param applyCreditnotes
   *          List of ApplyCreditnote object.
   * @return Returns the Credit object.
   * @throws Exception
   *           the exception
   */

  public Credit addCredits(String invoiceId, List<InvoicePayment> invoicePayments,
      List<ApplyCreditnote> applyCreditnotes) throws Exception {
   ...
   *          ID of credit notes applied to an Invoice.
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */

  public String deleteAppliedCredit(String invoiceId, 
      String creditnotesInvoiceId) throws Exception {

    String urlString = url + "/" + invoiceId + "/creditsapplied/" 
        + creditnotesInvoiceId; // No I18N
   ...
   * The paramMap contains the possible key and value as mentioned below: <br>
   * <br>
   * can_send_in_mail - True to send the attachment with the invoice when emailed.<br>
   * <br>
  ...
  public String addAttachment(String invoiceId, File file, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * The queryMap contains the possible key and value as mentioned below: <br>
   * <br>
   * preview - Get the thumbnail of the attachment.<br>
   * <br>
   ...
   * The paramMap contains the possible key and value as mentioned below: <br>
   * <br>
   * can_send_in_mail* - Boolean to send the attachment with the invoice when emailed.<br>
   * <br>
  ...
  public String updateAttachment(String invoiceId, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * Pass the invoiceId, description, paymentExpectedDate, and showCommentToClients to add the
   * comment for an invoice.
   * It returns the Comment object.
   *
   * @param invoiceId
   *          ID of an Invoice.
   * @param description
   *          Description is the comment of an Invoice.
   * @param paymentExpectedDate
   *          Expected date of payment for the invoice.
   * @param showCommentToClients
  ...
  public Comment addComment(String invoiceId, String description, String paymentExpectedDate,
      boolean showCommentToClients) throws Exception {
   ...
   * Pass the invoiceId, commentId, description,
   * and showCommentToClients to update a comment for an
   * invoice.
   * It returns the Comment object.
   *
   * @param invoiceId
  ...
  public Comment updateComment(String invoiceId, String commentId, String description,
      boolean showCommentToClients) throws Exception {
