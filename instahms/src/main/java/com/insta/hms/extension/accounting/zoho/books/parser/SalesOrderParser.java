...
public class SalesOrderParser {
   ...
   *
   * @param response
   *          JSON response contains the details of list of sales orders.
   ...
   *
   * @param response
   *          JSON response contains the details of the sales order.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the sales order.
   * @return Returns the SalesOrder object.
   * @throws JSONException
   *           the JSON exception
   */
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the line item.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the tax.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the custom field.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the shipping or billing address.
   ...
   *
   * @param response
   *          JSON response contains the details of the email content.
   ...
   *
   * @param response
   *          JSON response contains the details of list of templates.
   ...
   *
   * @param response
   *          JSON response contains the details of list of comments.
   ...
   *
   * @param response
   *          JSON response contains the details of the comment.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the comment.
   * @return Returns the Comment object.
   * @throws JSONException
   *           the JSON exception
   */
   ...
   *
   * @param response
   *          JSON response contains the success message.
