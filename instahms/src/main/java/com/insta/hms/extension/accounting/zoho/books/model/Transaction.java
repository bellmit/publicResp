...
public class Transaction {
  ...
  /** The categorized transaction id. */
  ...
  /** The transaction type formatted. */
  ...
  /** The offset account name. */
  private String offsetAccountName = "";

  /** The reference number. */
  private String referenceNumber = "";

  /** The reconcile status. */
   ...
   *          Date in which the transaction made.
   */
   ...
   * 
   * @param transactionTypeFormatted
   *          Format of the transaction type.
   */
   ...
   * 
   * @param debitOrCredit
   *          The transaction made from debit or credit.
   */
   ...
   * 
   * @param offsetAccountName
   *          Name of the offset account for the transaction.
   */
   ...
   *          Reconcile status of the transaction.
   */
   ...
   * 
   * @param debitAmount
   *          Debited amount for the transaction.
   */
   ...
   * 
   * @param creditAmount
   *          Credited amount for the transaction.
   */
   ...
   * 
   * @param statusFormatted
   *          Status format of the transaction.
   */
   ...
   * 
   * @param fromAccountId
   *          The account ID from which money will be transferred.
   */
   ...
   * 
   * @param toAccountId
   *          ID of the account to which the money gets transferred.
   */
   ...
   * 
   * @param toAccountName
   *          Name of the account to which the money gets transferred.
   */
   ...
   *
   * @param associateTransactions
   *          List of associate Transaction object.
   * @throws Exception
   *           the exception
   */
