...
public class LineItem {
   ...
   * 
   * @param taxName
   *          Name of the tax or tax group applied to the line item.
   */
   ...
   * 
   * @param taxType
   *          Type of the tax or tax group applied to the line item.
   */
   ...
   * 
   * @param expenseId
   *          ID of the expense which is invoiced.
   */
   ...
   * 
   * @param expenseItemId
   *          ID of the expense item which is invoiced.
   */
   ...
   *          Expense receipt name for the line item.
   */
   ...
   * 
   * @param taxPercentage
   *          Percentage of the tax or tax group applied to the line item.
   */
   ...
   * 
   * @param debitOrCredit
   *          Whether the accounts needs to be debited or credited.
   */
   ...
   * 
   * @param isInvoiced
   *          True or flase to set the item is invoiced or not.
   */
