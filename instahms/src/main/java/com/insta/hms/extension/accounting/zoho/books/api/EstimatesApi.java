...
import com.insta.hms.extension.accounting.zoho.books.model.Estimate;
import com.insta.hms.extension.accounting.zoho.books.model.EstimateList;
...
import com.insta.hms.extension.accounting.zoho.books.parser.EstimateParser;
 ...
 * The list of estimate comments.<br>
 * <br>
...
public class EstimatesApi extends API {
   ...
   *
   * @param customerId
   *          ID of the customer the estimate has to be created.
   * @param itemName
   ...
   * The possible keys and values are as mentioned below: <br>
   * <br>
   * send = 'true' or 'false' <br>
   * ignore_auto_number_generation = 'true' or 'false' <br>
   * <br>
   * It returns the Estimate object.
   *
   * @param estimate
   *          Estimate object.
   * @param paramMap
   *          It contains the parameter value in the form of key-value pair.
   * @return Returns an Estimate object.
   * @throws Exception
   *           the exception
   */
   ...
   * The paramMap contains the key and value as mentioned below: <br>
   * <br>
   * ignore_auto_number_generation = 'true' or 'false'<br>
   * <br>
   * It returns the Estimate object.
   ...
   *          Estimate object.
   * @param paramMap
   *          Ignore auto estimate number generation for this estimate. This mandates the estimate
   *          number.
   * @return Returns an Estimate object.
   * @throws Exception
   *           the exception
   ...
   * <td>Search estimates by estimate number.<br>
   * Variants: <i>estimate_number_startswith</i> and <i>estimate_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>reference_number</td>
   * <td>Search estimates by estimates reference number.<br>
   * Variants: <i>reference_number_startswith</i> and <i>reference_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_name</td>
   * <td>Search estimates by customer name.<br>
   * Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>total</td>
   * <td>Search estimates by estimate total.<br>
   * Variants: <i>total_less_than, total_less_equals, total_greater_than</i> and
   * <i>total_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>customer_id</td>
   * <td>Search estimates by customer id.</td>
   * </tr>
   * <tr>
   * <td>item_name</td>
   * <td>Search estimates by item name.<br>
   * Variants: <i>item_name_startswith</i> and <i>item_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_id</td>
   * <td>Search estimates by item id.</td>
   * </tr>
   * <tr>
   * <td>item_description</td>
   * <td>Search estimates by item description.<br>
   * Variants: <i>item_description_startswith</i> and <i>item_description_contains</i></td>
   * </tr>
   * <tr>
   * <td>custom_field</td>
   * <td>Search estimates by custom field. Variants: <i>custom_field_startswith</i> and
   * <i>custom_field_contains</i></td>
   * </tr>
   * <tr>
   * <td>expiry_date</td>
   * <td>Search estimates by expiry date. Variants: <i>expiry_date_start, expiry_date_end,
   * expiry_date_before</i> and <i>expiry_date_after</i></td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search estimates by invoice date.<br>
   * Variants: <i>date_start, date_end, date_before</i> and <i>date_after</i></td>
   * </tr>
   * <tr>
   * <td>status</td>
   * <td>Search estimates by status.<br>
   * Allowed Values: <i>draft, sent, invoiced, accepted, declined</i> and <i>expired</i></td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search estimates by estimate number or reference or customer name.</td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter estimates by status.<br>
   * Allowed Values: <i>Status.All, Status.Sent, Status.Draft, Status.Invoiced, Status.Accepted,
   * Status.Declined</i> and <i>Status.Expired</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort estimates. <br>
   * Allowed Values: <i>customer_name, estimate_number, date, total</i> 
  ...
  /**
   * Email an estimate to the customer (If the Email object is empty, email will be sent with
  ...
  public Email getEmailContent(String estimateId, HashMap<String, Object> queryMap)
      throws Exception {
   ...
   *
   * @param queryMap
   *          Comma separated estimate ids which are to be exported as pdf.
  ...
  /**
   * Update the billing address for this estimate alone 
  ...
  /**
   * Update the shipping address for an existing estimate alone 
   * (You can set this address as default
   * shipping address for your customer by specifying 'is_update_customer' param as true).
  ...
  public String updateShippingAddress(String estimateId, 
      Address shippingAddress) throws Exception {
  ...
  public Comment addComment(String estimateId, String description, boolean showCommentToClients)
      throws Exception {
   ...
   * Pass the estimateId, commentId, description, 
   * and showCommentToClients to update the comment for
   * the estimate.
  ...
  public Comment updateComment(String estimateId, String commentId, String description,
