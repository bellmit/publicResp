...
public class BaseCurrencyAdjustment {
  ...
  /** The adjustment date formatted. */
  private String adjustmentDateFormatted = "";

  /** The currency code. */
  private String currencyCode = "";

  /** The base currency adjustment id. */
   ...
   * 
   * @param description
   *          Description of the base currency adjustment.
   */
   ...
   * 
   * @param adjustmentDateFormatted
   *          Format of the base currency adjustment.
   */
   ...
   * 
   * @param gainOrLoss
   *          Gain or loss for base currency adjustment.
   */
