...
import com.insta.hms.extension.accounting.zoho.books.parser.ChartOfAccountParser;
 ...
 * The list transaction for an account.<br>
 * <br>
 * It is used to change the status:<br>
 * <br>
 * Mark an account as active.<br>
 * Mark an account as inactive.<br>
 * <br>
...
public class ChartOfAccountsApi extends API {
   ...
   * The ChartOfAccount object which contains accountId is the mandatory parameter for which chart
   * of account has to be changed.
   * It returns the ChartOfAccount object.
   *
   * @param chartOfAccount
   *          ChartOfAccount object.
   ...
   * <tr>
   * <td>showbalance</td>
   * <td>Boolean to get current balance of accounts.</td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter accounts based on its account type and status.<br>
   * Allowed Values: <i>AccountType.All, AccountType.Active, AccountType.Inactive,
   * AccountType.Asset, AccountType.Liability, AccountType.Equity, AccountType.Income</i> and
   * <i>AccountType.Expense</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort accounts<br>
   * Allowed Values: <i>account_name</i> and <i>account_type</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   ...
   * <tr>
   * <td>account_id</td>
   * <td>ID of the account. List all transactions involved this account.</td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search account transactions with the given date range.
   * Default date format is yyyy-mm-dd.<br>
   * Variants: <i>date.start, date.end, date.before</i> and <i>date.after</i></td>
   * </tr>
   * <tr>
   * <td>amount</td>
   * <td>Search account transactions with given amount range. <br>
   * Variants: <i>amount.less_than, amount.less_equals, amount.greater_than</i> and
   * <i>amount.greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter transactions based on its type. <br>
   * Allowed Values: <i>TransactionType.All, TransactionType.BaseCurrencyAdjustment,
   * TransactionType.Bills, TransactionType.VendorPayment, TransactionType.CardPayment,
   * TransactionType.CreditNotes, TransactionType.CreditNoteRefund, TransactionType.Deposit,
   * TransactionType.Expense, TransactionType.Invoice, TransactionType.Journal,
   * TransactionType.CustomerPayment, TransactionType.TransferFund</i> and
   * <i>TransactionType.OpeningBalance</i></td>
   * </tr>
   * <tr>
   * <td>transaction_type</td>
   * <td>Search transactions based on the given transaction type. <br>
   * Allowed Values: <i>invoice, customer_payment, bills, vendor_payment, credit_notes,
   * creditnote_refund, expense, card_payment, purchase_or_charges, journal, deposit, refund,
   * transfer_fund, base_currency_adjustment, opening_balance, sales_without_invoices,
   * expense_refund, tax_refund, receipt_from_initial_debtors, owner_contribution, interest_income,
   * other_income, owner_drawings</i> and <i>payment_to_initial_creditors</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort transactions. <br>
   * Allowed Values: <i>transaction_date, payee, glname, transaction_type_formatted,
   * reconcile_status, debit_amount</i> and <i>credit_amount</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   * @param accountId
   *          ID of the account. List all transactions involved this account.
   * @param queryMap
   *          It contains the query string parameters in the form of key-value pair.
  ...
  public TransactionList getTransactions(String accountId, HashMap<String, Object> queryMap)
      throws Exception {
