 ...
 * The current user for the organization.<br>
 * <br>
...
public class UsersApi extends API {
   ...
   * Pass the filters in the form of key, value pair to get all the users from the organization
   * based on the filter.
   ...
   * <tr>
   * <td>filter_by</td>
   * <td>Filter through users with user status. <br>
   * Allowed Values: <i>Status.All, Status.Active, Status.Inactive, Status.Invited</i> and
   * <i>Status.Deleted</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort users.<br>
   * Allowed Values: <i>name, email, user_role</i> and <i>status</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
