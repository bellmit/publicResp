...
public class PaymentGateway {
  ...
  /** The additional field 1. */
  private String additionalField1 = "";

  /** The additional field 2. */
  private String additionalField2 = "";

  /** The additional field 3. */
   ...
   * 
   * @param gatewayName
   *          Name of the payment gateway associated with the invoice. E.g. paypal,
   *          google_check_out.
   */
   ...
   *          Supported currencies for the payment gateway.
   */
   ...
   * 
   * @param enabled
   *          To determine whether the payment gateway is enabled or disabled.
   */
   ...
   * 
   * @param configured
   *          To determine whether the payment gateway is configured or not.
   */
