...
public class TimeEntry {
   ...
   * 
   * @param isCurrentUser
   *          To specify the user is current user or not.
   */
   ...
   * 
   * @param billedStatus
   *          Billed status of the time entry.
   */
   ...
   *          In which time the timer started.
   */
   ...
   * 
   * @param timerDurationInMinutes
   *          Timer duration in minutes of the time entry.
   */
   ...
   * 
   * @param createdTime
   *          Created time of the time entry.
   */
