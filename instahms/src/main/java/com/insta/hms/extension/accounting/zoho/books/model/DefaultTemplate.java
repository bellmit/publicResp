...
public class DefaultTemplate {
   ...
   * 
   * @param creditnoteTemplateId
   *          ID of the creditnote template.
   */
   ...
   * 
   * @param creditnoteTemplateName
   *          Name of the creditnote template.
   */
   ...
   * 
   * @param invoiceEmailTemplateId
   *          ID of the invoice email template.
   */
   ...
   * 
   * @param invoiceEmailTemplateName
   *          Name of the invoice email template.
   */
   ...
   * 
   * @param estimateEmailTemplateId
   *          ID of the estimate email template.
   */
   ...
   * 
   * @param estimateEmailTemplateName
   *          Name of the estimate email template.
   */
   ...
   * 
   * @param creditnoteEmailTemplateId
   *          ID of the creditnote email template.
   */
   ...
   * 
   * @param creditnoteEmailTemplateName
   *          Name of the creditnote email template.
   */
