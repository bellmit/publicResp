...
import com.insta.hms.extension.accounting.zoho.books.model.Rule;
import com.insta.hms.extension.accounting.zoho.books.model.RuleList;
import com.insta.hms.extension.accounting.zoho.books.parser.BankRuleParser;
...
public class BankRulesApi extends API {
   ...
   *
   * @param accountId
   *          Mandatory parameter Account Id for which rules have to be listed.
  ...
  /**
   * Create a rule and apply it on deposit/withdrawal for bank accounts and on refund/charges for
   * credit card accounts.
   * Pass the Rule object to create a rule for the bank account.
   * The Rule object which contains ruleName, targetAccountId, applyTo, criteriaType, field,
   * comparator, and recordAs are the mandatory parameters.
   * It returns the Rule object.
   *
   * @param rule
   *          Rule object.
   ...
   * The Rule object which contains ruleId is the mandatory parameter for which rule has to be
   * updated.
   * It returns the Rule object.
   *
   * @param rule
