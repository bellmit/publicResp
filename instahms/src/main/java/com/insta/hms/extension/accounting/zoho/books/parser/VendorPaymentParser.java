...
public class VendorPaymentParser {
   ...
   *
   * @param response
   *          This json response contains the vendor payment details.
   ...
   *
   * @param response
   *          This json response contains list of vendor payments details.
  ...
  public VendorPaymentList getVendorPayments(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      // No I18N
      vendorPayment.setExchangeRate(jsonArray.getJSONObject(i).getDouble("exchange_rate"));
      vendorPayment.setAmount(jsonArray.getJSONObject(i).getDouble("amount")); // No I18N
      vendorPayment.setPaidThroughAccountId(jsonArray.getJSONObject(i).getString(
          "paid_through_account_id"));
      vendorPayment.setPaidThroughAccountName(jsonArray.getJSONObject(i).getString(
