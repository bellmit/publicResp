...
public class PurchaseOrderParser {
   ...
   *
   * @param response
   *          JSON response contains the details of list of purchase orders.
   ...
   *
   * @param response
   *          JSON response contains the details of the purchase order.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the purchase order.
   * @return Returns the PurchaseOrder object.
