...
import com.insta.hms.extension.accounting.zoho.books.model.PurchaseOrder;
import com.insta.hms.extension.accounting.zoho.books.model.PurchaseOrderList;
import com.insta.hms.extension.accounting.zoho.books.model.TemplateList;
import com.insta.hms.extension.accounting.zoho.books.parser.PurchaseOrderParser;
...
public class PurchaseOrderApi extends API {
  ...
  // PurchaseOrderParser is used to parse the JSON response and 
  // make it into the respective objects.

  /** The purchase order parser. */
   ...
   * @param file
   *          Attachment file for the purchase order.
   * @return Returns the PurchaseOrder object.
   * @throws Exception
   *           the exception
   */

  public PurchaseOrder create(HashMap<String, Object> paramMap, PurchaseOrder purchaseOrder,
  ...
  public PurchaseOrder update(HashMap<String, Object> paramMap, PurchaseOrder purchaseOrder,
      File file) throws Exception {
  ...
  /**
   * Email a purchase order to the vendor. Input json string is not mandatory. If input json string
  ...
  public String sendEmail(String purchaseorderId, HashMap<String, Object> paramMap, Email email)
      throws Exception {
  ...
  public Email getEmailContent(String purchaseorderId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  /**
   * Updates the billing address for this purchase order alone. You can set this address as default
   * billing address for your vendor by specifying 'is_update_customer' param as true.
   *
   * @param purchaseorderId
   *          ID of the purchase order.
   * @param address
  ...
  public File getAttachment(String purchaseorderId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  public String updateAttachment(String purchaseorderId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  public Comment addComment(String purchaseorderId, String description, 
  ...
  public Comment updateComment(String purchaseorderId, String commentId, String description,
      String expectedDeliveryDate) throws Exception {
