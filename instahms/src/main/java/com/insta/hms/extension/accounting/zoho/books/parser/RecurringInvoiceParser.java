...
/**
 * RecurringInvoiceParser is used to parse the json response and make it into the respective
 * objects.
 */
...
public class RecurringInvoiceParser {
   ...
   *
   * @param response
   *          This json response contains list of recurring invoices details.
  ...
  public RecurringInvoiceList getRecurringInvoices(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      recurringInvoice.setRecurringInvoiceId(jsonArray.getJSONObject(i).getString(
      ...
      recurringInvoice
          .setNextInvoiceDate(jsonArray.getJSONObject(i).getString("next_invoice_date"));
      recurringInvoice.setRecurrenceFrequency(jsonArray.getJSONObject(i).getString(
          "recurrence_frequency"));
      // No I18N
      recurringInvoice.setRepeatEvery(jsonArray.getJSONObject(i).getInt("repeat_every"));
   ...
   *
   * @param response
   *          This json response contains the recurring invoice details.
  ...
  public RecurringInvoice getRecurringInvoice(String response) throws Exception {
    ...
    // No I18N
    recurringInvoice.setIsDiscountBeforeTax(recurring.getBoolean("is_discount_before_tax"));
    ...
    // No I18N
    recurringInvoice.setAllowPartialPayments(recurring.getBoolean("allow_partial_payments"));
   ...
   *
   * @param response
   *          This json response contains list of comments details for recurring invoices.
