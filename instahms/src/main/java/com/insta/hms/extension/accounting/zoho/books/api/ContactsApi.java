...
import com.insta.hms.extension.accounting.zoho.books.parser.ContactParser;
...
public class ContactsApi extends API {
  ...
  /**
   * Update an existing contact (To delete a contact person remove it from the contact persons
   * list).
   ...
   * <tr>
   * <td>contact_name</td>
   * <td>Search contacts by contact name.<br>
   * Variants: <i>contact_name_startswith</i> and <i>contact_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>first_name</td>
   * <td>Search contacts by first name of the contact person.<br>
   * Variants: <i>first_name_startswith</i> and <i>first_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>last_name</td>
   * <td>Search contacts by last name of the contact person.<br>
   * Variants: <i>last_name_startswith</i> and <i>last_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>address</td>
   * <td>Search contacts by any of the address fields.<br>
   * Variants: <i>address_startswith</i> and <i>address_contains</i></td>
   * </tr>
   * <tr>
   * <td>email</td>
   * <td>Search contacts by email of the contact person.<br>
   * Variants: <i>email_startswith</i> and <i>email_contains</i></td>
   * </tr>
   * <tr>
   * <td>phone</td>
   * <td>Search contacts by phone number of the contact person.<br>
   * Variants: <i>phone_startswith</i> and <i>phone_contains</i></td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>contact name or notes.</td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter contacts by status.<br>
   * Allowed Values: <i>Status.All, Status.Active, Status.Inactive, Status.Duplicate,
   * Status.Customers, Status.Vendors</i> and <i>Status.Crm</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort contacts.<br>
   * Allowed Values: <i>contact_name, first_name, last_name, email, outstanding_receivable_amount,
   * outstanding_payable_amount, created_time</i> and <i>last_modified_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
  ...
  /**
   * Email statement to the contact (If the Email object is not given, email will be sent with the
   ...
   * The parameter contains the possible keys as mentioned below: <br>
   * <br>
   * start_date - start date for the statement. <br>
   * end_date - End date for the statement. <br>
   * <br>
  ...
  public String sendEmailStatement(String contactId, Email email, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * Pass the filters in the form of key-value pair to get the statement email content based on the
   * filter.
   * The queryMap contains the possible keys as mentioned below: <br>
   * <br>
   * start_date - Start date for statement. <br>
   * end_date - End date for statement. <br>
   * The above mentioned filters are the mandatory paramters. <br>
   * <br>
  ...
  public Email getStatementMailContent(String contactId, HashMap<String, Object> queryMap)
      throws Exception {
   ...
   * <br>
   * send_customer_statement - Send customer statement pdf with email. <br>
   * <br>
  ...
  public String sendEmailContact(String contactId, Email email, HashMap<String, Object> paramMap)
      throws Exception {
  ...
  /**
   * Track a contact for 1099 reporting. (Note: This API is only available when the organization's
   * country is U.S.A)
  ...
  /**
   * Use this API to stop tracking payments to a vendor for 1099 reporting. (Note: This API is only
   * available when the organization's country is U.S.A)
