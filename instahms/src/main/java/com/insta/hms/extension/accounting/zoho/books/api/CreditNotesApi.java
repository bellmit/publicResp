...
import com.insta.hms.extension.accounting.zoho.books.model.CreditNote;
import com.insta.hms.extension.accounting.zoho.books.model.CreditNoteList;
import com.insta.hms.extension.accounting.zoho.books.model.CreditnoteRefund;
import com.insta.hms.extension.accounting.zoho.books.model.CreditnoteRefundList;
import com.insta.hms.extension.accounting.zoho.books.model.Email;
import com.insta.hms.extension.accounting.zoho.books.model.EmailHistoryList;
...
import com.insta.hms.extension.accounting.zoho.books.model.InvoicesCreditedList;
...
import com.insta.hms.extension.accounting.zoho.books.parser.CreditNoteParser;
 ...
 * The list of credit note comments.<br>
 * <br>
 * It is used to:<br>
 * <br>
 ...
 * Add a comment for the credit note.<br>
 * <br>
...
public class CreditNotesApi extends API {
   ...
   *
   * @param customerId
   *          ID of the customer the credit note has to be created.
   * @param accountId
   ...
   * The paramMap contains the possible keys as mentioned below:<br>
   * <br>
   * invoice_id - Create a credit note and apply it to an invoice.<br>
   * ignore_auto_number_generation - Ignore auto number generation for this credit note only. To
   * enable this option credit note number is mandatory.<br>
   * <br>
   * It returns the CreditNote object.
   *
   * @param creditNote
   *          CreditNote object.
   * @param paramMap
   *          It contains the query string in the form of key-value pair.
   * @return Returns the CreditNote object.
   * @throws Exception
   *           the exception
   */

  public CreditNote create(CreditNote creditNote, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * <br>
   * ignore_auto_number_generation - Allow editing of credit note number.<br>
   * <br>
   * The CreditNote object which contains creditNoteId is the mandatory parameter for which credit
   * note details has to be updated.
   * It returns the CreditNote object.
   *
   * @param creditNote
   *          CreditNote object.
   * @param paramMap
   *          It contains the parameters in the form of key-value pair.
   * @return Returns a CreditNote object.
   * @throws Exception
   *           the exception
   */

  public CreditNote update(CreditNote creditNote, HashMap<String, Object> paramMap)
      throws Exception {
   ...
   * <td>Search credit notes by credit note number.<br>
   * Variants: <i>creditnote_number_startswith</i> and <i>creditnote_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search credit notes by credit note date.<br>
   * Variants: <i>date_start, date_end, date_before</i> and <i>date_after</i></td>
   * </tr>
   * <tr>
   * <td>total</td>
   * <td>Search credit notes by credit note total amount.<br>
   * Variants: <i>total_less_than, total_less_equals, total_greater_than</i> and
   * <i>total_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>reference_number</td>
   * <td>Search credit notes by credit note reference number.<br>
   * Variants: <i>reference_number_startswith</i> and <i>reference_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_name</td>
   * <td>Search credit notes by customer name.<br>
   * Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_name</td>
   * <td>Search credit notes by item name.<br>
   * Variants: <i>item_name_startswith</i> and <i>item_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_description</td>
   * <td>Search credit notes by credit note item description.<br>
   * Variants: <i>item_description_startswith</i> and <i>item_description_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_id</td>
   * <td>Search credit notes by customer id.</td>
   * </tr>
   * <tr>
   * <td>line_item_id</td>
   * <td>Search credit notes by credit note line item id.</td>
   * </tr>
   * <tr>
   * <td>item_id</td>
   * <td>Search credit notes by item id.</td>
   * </tr>
   * <tr>
   * <td>tax_id</td>
   * <td>Search credit notes by tax id.</td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search credit notes by credit note number or customer name or credit note reference number.
   * </td>
   * </tr>
   * <tr>
   * <td>status</td>
   * <td>Search credit notes by credit note status. Allowed statuses are draft,open,closed and void.
   * <br>
   * Allowed Values: <i>open, closed</i> and <i>void</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter credit notes by statuses.<br>
   * Allowed Values: <i>Status.All, Status.Open, Status.Draft, Status.Closed</i> 
   * and <i>Status.Void</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort credit notes by following columns customer_name, creditnote_number, balance, total,
   * date and created_time.<br>
   * Allowed Values: <i>customer_name, creditnote_number, balance, total, date</i> and
   * <i>created_time</i>
   * </td>
   * </tr>
   * </tbody>
   ...
   * Pass the creditNoteId, Email object and query string parameters to send an email credit note to
   * a customer.
   * The paramMap contains the possible key as mentioned below: <br>
   * <br>
   ...
   *          Email object.
   * @param paramMap
   *          It contains the ID of the customer.
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */

  public String sendEmail(String creditNoteId, Email email, HashMap<String, Object> paramMap)
      throws Exception {
  ...
  public Email getEmailContent(String creditNoteId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  /**
   * Update the billing address for an existing credit note alone (You can set this address as
   * default billing address for your customer by specifying 'is_update_customer' node as true).
  ...
  /**
   * Update the shipping address for an existing credit note alone (You can set this address as
   * default shipping address for your customer by specifying 'is_update_customer' node as true).
  ...
  public String updateShippingAddress(String creditNoteId, Address shippingAddress)
      throws Exception {
   ...
   * Pass the creditNoteId and creditNoteInvoiceId to delete the invoices credited for the credit
   * note.
   ...
   *          ID of the invoice, the credit note is being applied.
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */

  public String deleteInvoicesCredited(String creditNoteId, String creditnoteInvoiceId)
      throws Exception {
  ...
  public CreditnoteRefund addRefund(String creditNoteId, CreditnoteRefund creditnoteRefund)
      throws Exception {
   ...
   *          ID of the Creditnote refund.
   * @return Returns the CreditnoteRefund object.
   * @throws Exception
   *           the exception
   */

  public CreditnoteRefund getRefund(String creditNoteId, String creditnoteRefundId)
      throws Exception {
  ...
  public CreditnoteRefund updateRefund(String creditNoteId, CreditnoteRefund creditnoteRefund)
      throws Exception {

    String urlString = url + "/" + creditNoteId + "/refunds/"
        + creditnoteRefund.getCreditnoteRefundId(); // No I18N
   ...
   * <tr>
   * <td>customer_id</td>
   * <td>List credit note refunds made for a particular customer.</td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort refunds list. <br>
   * Allowed Values: <i>refund_mode, reference_number, date, creditnote_number, customer_name,
   * amount_bcy</i> and <i>amount_fcy</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
  ...
  public CreditnoteRefundList getCreditnoteRefunds(HashMap<String, Object> queryMap)
      throws Exception {
