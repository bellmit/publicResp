...
import com.insta.hms.extension.accounting.zoho.books.model.Account;
import com.insta.hms.extension.accounting.zoho.books.model.Address;
import com.insta.hms.extension.accounting.zoho.books.model.AutoReminder;
import com.insta.hms.extension.accounting.zoho.books.model.AutoReminderList;
import com.insta.hms.extension.accounting.zoho.books.model.CreditnoteSetting;
import com.insta.hms.extension.accounting.zoho.books.model.Currency;
import com.insta.hms.extension.accounting.zoho.books.model.CurrencyList;
import com.insta.hms.extension.accounting.zoho.books.model.Customer;
import com.insta.hms.extension.accounting.zoho.books.model.EmailId;
import com.insta.hms.extension.accounting.zoho.books.model.EstimateSetting;
import com.insta.hms.extension.accounting.zoho.books.model.ExchangeRate;
import com.insta.hms.extension.accounting.zoho.books.model.ExchangeRateList;
import com.insta.hms.extension.accounting.zoho.books.model.Invoice;
import com.insta.hms.extension.accounting.zoho.books.model.InvoiceSetting;
import com.insta.hms.extension.accounting.zoho.books.model.Item;
import com.insta.hms.extension.accounting.zoho.books.model.ItemList;
import com.insta.hms.extension.accounting.zoho.books.model.ManualReminder;
import com.insta.hms.extension.accounting.zoho.books.model.ManualReminderList;
import com.insta.hms.extension.accounting.zoho.books.model.NotesAndTerms;
import com.insta.hms.extension.accounting.zoho.books.model.OpeningBalance;
import com.insta.hms.extension.accounting.zoho.books.model.Organization;
import com.insta.hms.extension.accounting.zoho.books.model.OrganizationList;
import com.insta.hms.extension.accounting.zoho.books.model.PageContext;
import com.insta.hms.extension.accounting.zoho.books.model.Preference;
import com.insta.hms.extension.accounting.zoho.books.model.Tax;
import com.insta.hms.extension.accounting.zoho.books.model.TaxGroup;
import com.insta.hms.extension.accounting.zoho.books.model.TaxList;
import com.insta.hms.extension.accounting.zoho.books.model.Term;
import com.insta.hms.extension.accounting.zoho.books.model.User;
import com.insta.hms.extension.accounting.zoho.books.model.UserList;
...
public class SettingsParser {
   ...
   *
   * @param response
   *          This json response contains the preference details.
  ...
  public Preference getPreferences(String response) throws Exception {
    ...
    // No I18N
    preferences.setNotifyMeOnOnlinePayment(preference.getBoolean("notify_me_on_online_payment"));
    preferences.setSendPaymentReceiptAcknowledgement(preference
        .getBoolean("send_payment_receipt_acknowledgement")); // No I18N
    preferences.setAutoNotifyRecurringInvoice(preference
        .getBoolean("auto_notify_recurring_invoice")); // No I18N
    preferences.setSnailMailIncludePaymentStub(preference
        .getBoolean("snail_mail_include_payment_stub")); // No I18N
    preferences.setIsShowPoweredBy(preference.getBoolean("is_show_powered_by")); // No I18N
    preferences.setAttachExpenseReceiptToInvoice(preference
        .getString("attach_expense_receipt_to_invoice"));
    ...
    for (int i = 0; i < autoReminders.length(); i++) {
      ...
      autoReminder.setPaymentReminderId(autoReminders.getJSONObject(i).getString(
          "payment_reminder_id"));
      // No I18N
      autoReminder.setIsEnabled(autoReminders.getJSONObject(i).getBoolean("is_enabled"));
      autoReminder.setNotificationType(autoReminders.getJSONObject(i)
          .getString("notification_type"));
      autoReminder.setAddressType(autoReminders.getJSONObject(i).getString("address_type"));
      // No I18N
      autoReminder.setNumberOfDays(autoReminders.getJSONObject(i).getInt("number_of_days"));
   ...
   *
   * @param response
   *          This json response contains list of organizations details.
  ...
  public OrganizationList getOrganizations(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      // No I18N
      organization.setIsDefaultOrg(jsonArray.getJSONObject(i).getBoolean("is_default_org"));
      organization.setPlanType(jsonArray.getJSONObject(i).getString("plan_type"));
      // No I18N
      organization.setTaxGroupEnabled(jsonArray.getJSONObject(i).getBoolean("tax_group_enabled"));
      ...
      organization.setFiscalYearStartMonth(jsonArray.getJSONObject(i).getString(
          "fiscal_year_start_month"));
      organization.setAccountCreatedDate(jsonArray.getJSONObject(i).getString(
          "account_created_date"));
      organization.setAccountCreatedDateFormatted(jsonArray.getJSONObject(i).getString(
          "account_created_date_formatted"));
      organization.setTimeZone(jsonArray.getJSONObject(i).getString("time_zone"));
      // No I18N
      organization.setIsOrgActive(jsonArray.getJSONObject(i).getBoolean("is_org_active"));
      ...
      // No I18N
      organization.setPricePrecision(jsonArray.getJSONObject(i).getInt("price_precision"));
   ...
   *
   * @param response
   *          This json response contains the organization details.
   ...
   *
   * @param response
   *          This json response contains list of items details.
   ...
   *
   * @param response
   *          This json response contains the item details.
   ...
   *
   * @param response
   *          This json response contains list of users details.
   ...
   *
   * @param response
   *          This json response contains the user details.
   ...
   *
   * @param response
   *          This json response contains the invoice setting details.
  ...
  public InvoiceSetting getInvoiceSettings(String response) throws Exception {
    ...
    // No I18N
    invoiceSettings.setIsDiscountBeforeTax(invoiceSetting.getBoolean("is_discount_before_tax"));
    ...
    invoiceSettings.setIsShippingChargeRequired(invoiceSetting
        .getBoolean("is_shipping_charge_required")); // No I18N
    // No I18N
    invoiceSettings.setIsAdjustmentRequired(invoiceSetting.getBoolean("is_adjustment_required"));
    // No I18N
    invoiceSettings.setIsOpenInvoiceEditable(invoiceSetting
        .getBoolean("is_open_invoice_editable"));
    // No I18N
    invoiceSettings.setWarnConvertToOpen(invoiceSetting.getBoolean("warn_convert_to_open"));
    // No I18N
    invoiceSettings.setWarnCreateCreditnotes(invoiceSetting.getBoolean("warn_create_creditnotes"));
    invoiceSettings.setAttachExpenseReceiptToInvoice(invoiceSetting
        .getString("attach_expense_receipt_to_invoice"));
    invoiceSettings.setInvoiceItemType(invoiceSetting.getString("invoice_item_type"));
    // No I18N
    invoiceSettings.setIsShowInvoiceSetup(invoiceSetting.getBoolean("is_show_invoice_setup"));
    // No I18N
    invoiceSettings.setIsSalesPersonRequired(invoiceSetting
        .getBoolean("is_sales_person_required"));
   ...
   *
   * @param response
   *          This json response contains the notes and terms details for invoice, estimate and
   *          creditnote settings.
   ...
   *
   * @param response
   *          This json response contains the estimate setting details.
  ...
  public EstimateSetting getEstimateSettings(String response) throws Exception {
    ...
    // No I18N
    estimateSettings.setIsDiscountBeforeTax(estimateSetting.getBoolean("is_discount_before_tax"));
    ...
    estimateSettings.setWarnEstimateToInvoice(estimateSetting
        .getBoolean("warn_estimate_to_invoice")); // No I18N
    estimateSettings.setIsSalesPersonRequired(estimateSetting
        .getBoolean("is_sales_person_required")); // No I18N
   ...
   *
   * @param response
   *          This json response contains the creditnote setting details.
   ...
   *
   * @param response
   *          This json response contains list of currencies details.
  ...
  public CurrencyList getCurrencies(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      // No I18N
      currency.setIsBaseCurrency(jsonArray.getJSONObject(i).getBoolean("is_base_currency"));
   ...
   *
   * @param response
   *          This json response contains the currency details.
   ...
   *
   * @param response
   *          This json response contains list of exchange rates details.
   ...
   *
   * @param response
   *          This json response contains the exchange rate details.
   ...
   *
   * @param response
   *          This json response contains list of taxes details.
   ...
   *
   * @param response
   *          This json response contains the tax details.
   ...
   *
   * @param response
   *          This json response contains the tax group details.
   ...
   *
   * @param response
   *          This json response contains the opening balance details.
   ...
   *
   * @param response
   *          This json response contains list of auto reminders details.
   ...
   *
   * @param response
   *          This json response contains the auto reminder details.
   ...
   *
   * @param response
   *          This json response contains list of manual reminders details.
   ...
   *
   * @param response
   *          This json response contains the manual reminder details.
