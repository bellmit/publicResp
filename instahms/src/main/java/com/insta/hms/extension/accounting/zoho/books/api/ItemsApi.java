 ...
 * Mark an active item as inactive. <br>
 * <br>
...
public class ItemsApi extends API {
   ...
   * Pass the filters in the form of key-value pair to get all the items from an organization based
   * on the filter.
   ...
   * <tr>
   * <td>name</td>
   * <td>Search items by name.<br>
   * Variants: <i>name_startswith</i> and <i>name_contains</i></td>
   * </tr>
   * <tr>
   * <td>description</td>
   * <td>Search items by description.<br>
   * Variants: <i>description_startswith</i> and <i>description_contains</i></td>
   * </tr>
   * <tr>
   * <td>rate</td>
   * <td>Search items by rate.<br>
   * Variants: <i>rate_less_than, rate_less_equals, rate_greater_than</i> and
   * <i>rate_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>tax_id</td>
   * <td>Search items by tax id.</td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search items by name or description.</td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter items by status.<br>
   * Allowed Values: <i>Status.All, Status.Active</i> and <i>Status.Inactive</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort items.<br>
   * Allowed Values: <i>name, rate</i> and <i>tax_name</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
