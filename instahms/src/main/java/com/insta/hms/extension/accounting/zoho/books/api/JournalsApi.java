...
import com.insta.hms.extension.accounting.zoho.books.model.JournalList;
import com.insta.hms.extension.accounting.zoho.books.parser.JournalParser;
...
public class JournalsApi extends API {
   ...
   * The Journal object which contains journalDate, amount, and debitOrCredit are the mandatory
   * parameters.
   ...
   * The Journal object which contains journalId is the mandatory parameter for which journal has to
   * be updated.
   * It returns the Journal object.
   *
   * @param journal
   ...
   * <tr>
   * <td>entry_number</td>
   * <td>Search journals by journal entry number. <br>
   * Variants: <i>entry_number_startswith</i> and <i>entry_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>reference_number</td>
   * <td>Search journals by journal reference number. <br>
   * Variants: <i>reference_number_startswith</i> and <i>reference_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search journals by journal date. <br>
   * Variants: <i>date_start, date_end, date_before</i> and <i>date_after</i></td>
   * </tr>
   * <tr>
   * <td>notes</td>
   * <td>Search journals by journal notes. <br>
   * Variants: <i>notes_startswith</i> and <i>notes_contains</i></td>
   * </tr>
   * <tr>
   * <td>total</td>
   * <td>Search journals by journal total. <br>
   * Variants: <i>total_less_than, total_less_equals, total_greater_than</i> and
   * <i>total_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter journals by journal date. <br>
   * Allowed Values: <i>JournalDate.All, JournalDate.Today, JournalDate.ThisWeek,
   * JournalDate.ThisMonth, JournalDate.ThisQuarter</i> and <i>JournalDate.ThisYear</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort journal list. <br>
   * Allowed Values: <i>journal_date, entry_number, reference_number</i> and <i>total</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
