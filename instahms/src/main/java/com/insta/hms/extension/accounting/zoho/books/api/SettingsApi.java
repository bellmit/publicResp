...
import com.insta.hms.extension.accounting.zoho.books.parser.SettingsParser;
 ...
 * The details of a manual reminder.<br>
 * <br>
 ...
 * The opening balance.<br>
 * <br>
 * It is used to enable and disable auto reminders.<br>
 * <br>
...
public class SettingsApi extends API {
   ...
   *
   * @param estimateSetting
   *          EstimateSetting object.
   * @return Returns the EstimateSetting object.
   * @throws Exception
   *           the exception
   */
   ...
   *
   * @param creditnoteSetting
   *          CreditnoteSetting object.
   * @return Returns the CreditnoteSetting object.
   * @throws Exception
   *           the exception
   */

  public CreditnoteSetting updateCreditnoteSettings(CreditnoteSetting creditnoteSetting)
      throws Exception {
  ...
  public NotesAndTerms updateCreditnotesNotesAndTerms(String notes, 
   ...
   * <tr>
   * <td>filter_by</td>
   * <td>Filter list of configured currencies excluding the base currency.<br>
   * Allowed Values: <i>Currencies.ExcludeBaseCurrency</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   * @param queryMap
   *          Filter list of configured currencies excluding the base currency.
   ...
   * The Currency object which contains currencyCode, currencySymbol, and currencyFormat are the
   ...
   * The Currency object which contains currencyId is the mandatory parameter for which currency
   * details has to be updated.
   * It returns the Currency object.
   *
   * @param currency
   *          Currency object.
   ...
   * Pass the currencyId and filters to get all the exchange rates for the currency based on the
   * filter.
   ...
   * <tr>
   * <td>from_date</td>
   * <td>Returns the exchange rate details from the given date or from previous 
   * closest match in the
   * absence of the exchange rate on the given date.</td>
   * </tr>
   * <tr>
   * <td>is_current_date</td>
   * <td>To return the exchange rate only if available for current date.</td>
   * </tr>
   * </tbody>
   * </table>
   *
  ...
  public ExchangeRateList getExchangeRates(String currencyId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  public ExchangeRate getExchangeRate(String currencyId, String exchangeRateId) throws Exception {
    // No I18N
    String urlString = url + "/currencies/" + currencyId + "/exchangerates/" + exchangeRateId;
  ...
  public ExchangeRate createExchangeRate(String currencyId, ExchangeRate exchangeRate)
      throws Exception {
   ...
   * The ExchangeRate object which contains exchangeRateId is the mandatory parameter for which
   * exchange rate details has to be updated.
   * It returns the ExchangeRate object.
   *
   * @param currencyId
   *          ID of the currency.
  ...
  public ExchangeRate updateExchangeRate(String currencyId, ExchangeRate exchangeRate)
      throws Exception {
    ...
    String urlString = url + "/currencies/" + currencyId + "/exchangerates/"
        + exchangeRate.getExchangeRateId(); // No I18N
    String response = ZohoHTTPClient.put(urlString, requestBody);
   ...
   * The Tax object which contains taxId is the mandatory parameter for which tax details has to be
   * updated.
   * It returns the Tax object.
   *
   * @param tax
  ...
  /**
   * Create a tax group associating multiple taxes (A tax group should contain minimum of 2
   * taxes.Only one compund tax can be associated to a tax group along with other taxes).
  ...
  public String updateTaxGroup(String taxGroupId, String taxGroupName, String taxes)
      throws Exception {
   ...
   * <tr>
   * <td>type</td>
   * <td>Type to select between open or overdue reminder. <br>
   * Allowed Values: <i>overdue_reminder</i> and <i>open_reminder</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   * @param queryMap
   *          Type to select between open or overdue reminder.
   ...
   *          ManualReminder object.
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */

  public String updateManualReminder(String reminderId, ManualReminder manualReminder)
      throws Exception {
