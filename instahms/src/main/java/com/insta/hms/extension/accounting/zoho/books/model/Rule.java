...
public class Rule {
   ...
   * 
   * @param applyTo
   *          Rule applies to either deposits or withdrawals for bank accounts and to refunds or
   ...
   * 
   * @param criteriaType
   *          Specifies whether all the criteria have to be satisfied or not.
   */
