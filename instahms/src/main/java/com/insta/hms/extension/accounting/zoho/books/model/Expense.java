...
public class Expense {
   ...
   * 
   * @param taxId
   *          ID of the tax or tax group applied to the expense.
   */
   ...
   * 
   * @param taxName
   *          Name of the tax or tax group applied to the expense.
   */
   ...
   * 
   * @param taxPercentage
   *          Percentage of the tax or tax group applied to the expense.
   */
   ...
   * 
   * @param currencyId
   *          ID of the currency in which expense amount is specified.
   */
   ...
   * 
   * @param currencyCode
   *          Code of the currency in which expense amount is specified.
   */
   ...
   * 
   * @param taxAmount
   *          Amount of the tax or tax group applied to the expense.
   */
   ...
   *          To specify if the tax is inclusive of the expense amount.
   */
   ...
   * 
   * @param isBillable
   *          To specify if the expense is billable.
   */
