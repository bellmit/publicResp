...
import com.insta.hms.extension.accounting.zoho.books.model.RecurringInvoice;
import com.insta.hms.extension.accounting.zoho.books.model.RecurringInvoiceList;
import com.insta.hms.extension.accounting.zoho.books.parser.RecurringInvoiceParser;
 ...
 * The list of recurring invoice history.<br>
 * <br>
 * It is used to: <br>
 * <br>
...
public class RecurringInvoicesApi extends API {
   ...
   * The recurringInvoice object which contains recurrenceName, customerId, and recurrenceFrequency
  ...
  /**
   * Update an existing recurring invoice (To delete a line item just remove it from the line_items
   * list).
   * Pass the RecurringInvoice object to update the details of a recurring invoice.
   * The recurringInvoice object which contains recurringInvoiceId is the mandatory parameter for
   * which recurring invoice details has to be updated.
   * It returns the RecurringInvoice object.
   *
   * @param recurringInvoice
   *          RecurringInvoice object.
   ...
   * Pass the filters in the form of key-value pair to get all the recurringInvoices based on the
   * filters.
   ...
   * <td>Search recurring invoices by name.<br>
   * Variants: <i>recurrence_name_startswith</i> and <i>recurrence_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_name</td>
   * <td>Search recurring invoices by item name.<br>
   * Variants: <i>item_name_startswith</i> and <i>profileitemname_contains</i></td>
   * </tr>
   * <tr>
   * <td>item_description</td>
   * <td>Search recurring invoices by item description.<br>
   * Variants: <i>item_description_startswith</i> and <i>item_description_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_name</td>
   * <td>Search recurring invoices by customer name.<br>
   * Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>line_item_id</td>
   * <td>Search recurring invoices by line item id.</td>
   * </tr>
   * <tr>
   * <td>item_id</td>
   * <td>Search recurring invoices by item id.</td>
   * </tr>
   * <tr>
   * <td>tax_id</td>
   * <td>Search recurring invoices by tax id.</td>
   * </tr>
   * <tr>
   * <td>notes</td>
   * <td>Search recurring invoices by notes.<br>
   * Variants: <i>notes_startswith</i> and <i>notes_contains</i></td>
   * </tr>
   * <tr>
   * <td>start_date</td>
   * <td>Search recurring invoices by start date.<br>
   * Variants: <i>start_date_start, start_date_end, start_date_before</i> and
   * <i>start_date_after</i></td>
   * </tr>
   * <tr>
   * <td>end_date</td>
   * <td>Search recurring invoices by end date.<br>
   * Variants: <i>end_date_start, end_date_end, end_date_before</i> and <i>end_date_after</i></td>
   * </tr>
   * <tr>
   * <td>customer_id</td>
   * <td>Search recurring invoices by customer id.</td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search recurring invoices by recurring invoice name or customer name.</td>
   * </tr>
   * <tr>
   * <td>status</td>
   * <td>Search recurring invoices by status.<br>
   * Allowed Values: <i>active, stopped</i> and <i>expired</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter recurring invoices by any status.<br>
   * Allowed Values: <i>Status.All, Status.Active, Status.Stopped</i> and <i>Status.Expired</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort recurring invoices. <br>
   * Allowed Values: <i>customer_name, recurrence_name, total, start_date, end_date, last_sent_date,
   * next_invoice_date</i> and <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
  ...
  public RecurringInvoiceList getRecurringInvoices(HashMap<String, Object> queryMap)
      throws Exception {

    String response = ZohoHTTPClient.get(url, getQueryMap(queryMap));

    RecurringInvoiceList recurringInvoiceList = recurringInvoiceParser
        .getRecurringInvoices(response);
   ...
   * Pass the recurringInvoiceId, templateId to update the respective template for the recurring
   * invoice.
