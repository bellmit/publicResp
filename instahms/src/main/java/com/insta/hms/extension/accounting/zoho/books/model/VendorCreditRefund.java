...
public class VendorCreditRefund {
   ...
   *          ID of the vendor credit refund id.
   */
   ...
   *          Reference number for the vendor credit refund.
   */
   ...
   * 
   * @param description
   *          Description for the vendor credit refund.
   */
