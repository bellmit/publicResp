...
public class RecurringInvoice {
   ...
   * 
   * @param total
   *          Total of the recurring invoice.
   */
   ...
   * 
   * @param customerId
   *          ID of the customer the recurring invoice has to be created.
   */
   ...
   * 
   * @param customerName
   *          Name of the customer the recurring invoice has to be created.
   */
   ...
   * 
   * @param startDate
   *          Start date of the recurring invoice. Invoices will not be generated for dates prior to
   *          the current date.
   */
   ...
   * 
   * @param lastSentDate
   *          Last sent date of the recurring invoice.
   */
   ...
   *          Next sent date of the recurring invoice.
   */
   ...
   *          Frequency of the recurring invoice. E.g. weekly, monthly, yearly.
   */
   ...
   * 
   * @param createdTime
   *          Created time for the recurring invoice.
   */
   ...
   * 
   * @param taxTotal
   *          Tax total of the recurring invoice.
   */
   ...
   * 
   * @param balance
   *          Total balance of the recurring invoice.
   */
   ...
   *          Payment gateways of an invoice.
   * @throws Exception
   *           the exception
   */
