...
public class Contact {
  ...
  /** The outstanding receivable amount. */
  private double outstandingReceivableAmount = 0.00;

  /** The outstanding receivable amount bcy. */
   ...
   *          Whether the contact has a transaction or not.
   */
   ...
   * 
   * @param isCrmCustomer
   *          Whether the contact has a crm customer or not.
   */
   ...
   *          Payment terms label of the contact.
   */
   ...
   *          Outstanding receivable amount of the contact.
   */
   ...
   * 
   * @param outstandingReceivableAmountBcy
   *          Outstanding receivable amount bcy of the contact.
   */
   ...
   * 
   * @param outstandingPayableAmount
   *          Outstanding payable amount of the contact.
   */
   ...
   * 
   * @param outstandingPayableAmountBcy
   *          Outstanding payable amount bcy of the contact.
   */
   ...
   *          unused credits receivable amount of the contact.
   */
   ...
   * 
   * @param unusedCreditsReceivableAmountBcy
   *          unused credits receivable amount bcy of the contact.
   */
   ...
   * 
   * @param unusedCreditsPayableAmount
   *          unused credits payable amount of the contact.
   */
   ...
   * 
   * @param unusedCreditsPayableAmountBcy
   *          unused credits payable amount bcy of the contact.
   */
   ...
   *          Whether the payment reminder is enabled or not.
   */
   ...
   * 
   * @param createdTime
   *          Which time the contact has been created.
   */
   ...
   *          The last modified time of the contact.
   */
   ...
   *          Default templates of a contact.
   * @throws Exception
   *           the exception
   */
   ...
   *          True or false to set the contact linked with zoho crm or not.
   */
   ...
   *          Price precision for the contact.
   */
   ...
   * 
   * @param associatedWithSquare
   *          True or false to set the contact associated with square.
   */
   ...
   * 
   * @param track1099
   *          True or false to set the contact is track1099 or not.
   */
