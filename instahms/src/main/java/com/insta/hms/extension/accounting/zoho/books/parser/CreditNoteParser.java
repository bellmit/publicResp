...
import com.insta.hms.extension.accounting.zoho.books.model.EmailHistory;
...
import com.insta.hms.extension.accounting.zoho.books.model.InvoicesCredited;
...
public class CreditNoteParser {
   ...
   *
   * @param response
   *          This json response contains list of credit notes details.
   ...
   *
   * @param response
   *          This json response contains the credit note details.
   ...
   *
   * @param response
   *          This json response contains list of email histories details for credit note.
   ...
   *
   * @param response
   *          This json response contains the email content details for credit note.
   ...
   *
   * @param response
   *          This json response contains list of invoices details for credit note.
   ...
   *
   * @param response
   *          This json response contains list of invoices credited details for credit note.
  ...
  public InvoicesCreditedList getInvoicesCredited(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      invoiceCredited.setCreditnoteInvoiceId(jsonArray.getJSONObject(i).getString(
      ...
      invoiceCredited
          .setCreditnoteNumber(jsonArray.getJSONObject(i).getString("creditnote_number"));
      // No I18N
      invoiceCredited.setCreditedAmount(jsonArray.getJSONObject(i).getDouble("credited_amount"));
   ...
   *
   * @param response
   *          This json response contains list of creditnote refunds details for credit note.
  ...
  public CreditnoteRefundList getRefunds(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      creditnoteRefund.setReferenceNumber(jsonArray
          .getJSONObject(i).getString("reference_number"));
   ...
   *
   * @param response
   *          This json response contains the creditnote refund details for credit note.
   ...
   *
   * @param response
   *          This json response contains list of templates details for credit note.
   ...
   *
   * @param response
   *          This json response contains list of comments details for credit note.
   ...
   *
   * @param response
   *          This json response contains the comment details for credit note.
