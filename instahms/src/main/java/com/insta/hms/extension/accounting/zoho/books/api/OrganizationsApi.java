...
public class OrganizationsApi extends API {
   ...
   * The Organization object which contains name, currencyId, and timeZone are the mandatory
   * parameters.
   * It returns the Organization object.
   *
   * @param organization
   ...
   * The Organization object must contain the organizationId for which organization details has to
   * be updated.
   * It returns the Organization object.
   *
   * @param organization
