...
public class Comment {
   ...
   * 
   * @param commentedById
   *          ID of the person who comment this.
   */
   ...
   * 
   * @param time
   *          Which time the comment has been created.
   */
   ...
   * 
   * @param commentedDate
   *          In which date the comment has been made.
   */
