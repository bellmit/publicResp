...
public class AutoReminder {
   ...
   * 
   * @param autoreminderId
   *          ID of the auto reminder.
   */
   ...
   * 
   * @param isEnabled
   *          To determine whether the payment reminder has been enabled or not.
   */
   ...
   * 
   * @param type
   *          Type to determine whether the email has to be sent before or after the due date of
   *          invoice.
   */
   ...
   * get the type.
   * 
   * @return Returns the Type to determine whether the email has to be sent before or after the due
   *         date of invoice.
   */
   ...
   * 
   * @param addressType
   *          Notification type for the payment reminder with option to reminder you, your customer
   *          or both.
   */
   ...
   * 
   * @return Returns the Notification type for the payment reminder with option to reminder you,
   *         your customer or both.
   */
   ...
   * 
   * @param numberOfDays
   *          Number of days before or after, the payment reminder email has to be sent.
   */
