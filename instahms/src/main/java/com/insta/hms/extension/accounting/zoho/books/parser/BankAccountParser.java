...
public class BankAccountParser {
   ...
   *
   * @param response
   *          This json response contains list of Bank Accounts details.
  ...
  public BankAccountList getBankAccounts(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      bankAccount.setUncategorizedTransactions(jsonArray.getJSONObject(i).getInt(
          "uncategorized_transactions")); // No I18N
      ...
      if (jsonArray.getJSONObject(i).has("is_primary_account")) {
        // No I18N
        bankAccount
            .setIsPrimaryAccount(jsonArray.getJSONObject(i).getBoolean("is_primary_account"));
      }
      if (jsonArray.getJSONObject(i).has("is_paypal_account")) {
        // No I18N
        bankAccount.setIsPaypalAccount(jsonArray.getJSONObject(i).getBoolean("is_paypal_account"));
      }
      if (jsonArray.getJSONObject(i).has("paypal_email_address")) {
        bankAccount.setPaypalEmailAddress(jsonArray.getJSONObject(i).getString(
   ...
   *
   * @param response
   *          This json response contains the details of a Bank Account.
  ...
  public BankAccount getBankAccount(String response) throws Exception {
    ...
    //No I18N
    bankAccount.setUncategorizedTransactions(bankAcc.getInt("uncategorized_transactions")); 
   ...
   *
   * @param response
   *          This json response contains the statement details of the account.
