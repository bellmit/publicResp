...
public class Payment {
   ...
   * 
   * @param date
   *          Date of the payment has been created.
   */
   ...
   * 
   * @param isSingleInvoicePayment
   *          To determine whether the invoice is single payment or not.
   */
   ...
   *          ID of the cash/ bank account the payment is made.
   */
   ...
   *          Name of the cash/ bank account the payment is made.
   */
   ...
   * 
   * @param isSingleBillPayment
   *          To determine whether the bill is single payment or not.
   */
