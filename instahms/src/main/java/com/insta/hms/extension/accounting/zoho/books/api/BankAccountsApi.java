...
import com.insta.hms.extension.accounting.zoho.books.model.BankAccount;
import com.insta.hms.extension.accounting.zoho.books.model.BankAccountList;
import com.insta.hms.extension.accounting.zoho.books.model.Statement;
import com.insta.hms.extension.accounting.zoho.books.parser.BankAccountParser;
import com.insta.hms.extension.accounting.zoho.books.util.ZohoHTTPClient;

import java.util.HashMap;

/**
 * BankAccountsApi is used to create a bank account or credit card account for the organization. It
 * is used to get:<br>
 * <br>
 * The list of bank accounts.<br>
 * The details of a bank account.<br>
 * <br>
 * It is used to change the status of an account:<br>
 * <br>
 * Make an account active.<br>
 * Make an account inactive.<br>
 * <br>
...
public class BankAccountsApi extends API {
   ...
   * <tr>
   * <td>filter_by</td>
   * <td>Filter the account by their status.<br>
   * Allowed Values: <i>Status.All, Status.Active</i> and <i>Status.Inactive</i></td>
   * </tr>
   * 
   * <tr>
   * <td>sort_column</td>
   * <td>Sort the values based on the allowed values.<br>
   ...
   * The BankAccount object which contains accountId is the mandatory parameter for which bank
   * account details have to be updated.
   * It returns the BankAccount object.
   *
   * @param bankAccount
   *          BankAccount object.
   ...
   *          ID of the bank account.
   * @param statementId
   *          Statement ID of the bank account.
   * @return Returns a String object.
   * @throws Exception
   *           the exception
   */
