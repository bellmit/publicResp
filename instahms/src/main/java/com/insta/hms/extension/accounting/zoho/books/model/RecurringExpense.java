...
public class RecurringExpense {
  ...
  /** The last created date. */
  private String lastCreatedDate = "";

  /** The next expense date. */
  ...
  /** The paid through account id. */
  private String paidThroughAccountId = "";

  /** The paid through account name. */
   ...
   * 
   * @param startDate
   *          Start date of the recurring expense. Expenses will not be generated for dates prior to
   *          the current date.
   */
   ...
   *          Frequency of the recurring expense. E.g. weekly, monthly, yearly.
   */
   ...
   * 
   * @param repeatEvery
   *          Frequency to repeat. E.g. 1, 6, 12.
   */
   ...
   *          Last created date of the recurring expense.
   */
   ...
   * 
   * @param nextExpenseDate
   *          Next expense date of the recurring expense.
   */
   ...
   * 
   * @param paidThroughAccountName
   *          Name of the cash/ bank account the expense is paid.
   */
   ...
   * 
   * @param vendorName
   *          Name of the vendor the expense is made.
   */
   ...
   * 
   * @param taxId
   *          ID of the tax or tax group applied to the recurring expense.
   */
   ...
   * 
   * @param taxName
   *          Name of the tax or tax group applied to the recurring expense.
   */
   ...
   * 
   * @param taxPercentage
   *          Percentage of the tax or tax group applied to the recurring expense.
   */
   ...
   * 
   * @param exchangeRate
   *          Exchange rate of the currency specified.
   */
   ...
   * 
   * @param taxAmount
   *          Amount of the tax or tax group applied to the recurring expense.
   */
   ...
   * 
   * @param subTotal
   *          Sub total of the recurring expense.
   */
   ...
   * 
   * @param total
   *          Total of the recurring expense.
   */
   ...
   * 
   * @param bcyTotal
   *          Bcy total of the recurring expense.
   */
   ...
   * 
   * @param isBillable
   *          Boolean to specify if the expense is billable.
   */
   ...
   * 
   * @param customerId
   *          ID of the customer, if the expense is billable.
   */
   ...
   * 
   * @param customerName
   *          Name of the customer, if the expense is billable.
   */
   ...
   * 
   * @param createdTime
   *          Created time of the recurring expense.
   */
   ...
   *          Last modified time of the recurring expense.
   */
   ...
   * 
   * @param projectName
   *          Name of the project associated with the customer.
   */
