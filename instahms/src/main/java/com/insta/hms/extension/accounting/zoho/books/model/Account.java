...
public class Account {
   ...
   * 
   * @param bcyBalanceFormatted
   *          Format of the bcy balance.
   */
   ...
   * 
   * @param fcyBalanceFormatted
   *          Format of the Fcy balance.
   */
   ...
   *          Adjusted balance of the account.
   */
   ...
   * 
   * @param adjustedBalanceFormatted
   *          Format of the Adjusted balance.
   */
   ...
   * 
   * @param gainOrLossFormatted
   *          Format of the gain or loss.
   */
   ...
   * 
   * @param glSpecificType
   *          Gl specific type of the account.
   */
   ...
   * 
   * @param accountSplitId
   *          Split ID of the account.
   */
