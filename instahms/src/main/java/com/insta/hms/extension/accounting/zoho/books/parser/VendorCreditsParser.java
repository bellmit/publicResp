...
import com.insta.hms.extension.accounting.zoho.books.model.BillsCredited;
...
public class VendorCreditsParser {
   ...
   *
   * @param response
   *          JSON response contains the details of the list of vendor credits.
   ...
   *
   * @param response
   *          JSON response contains the details of a vendor credit.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of a vendor credit.
   * @return Returns the VendorCredit object.
   * @throws JSONException
   *           the JSON exception
   */
  ...
  public VendorCredit jsonToVendorCredit(JSONObject jsonObject) throws JSONException {
    ...
    if (jsonObject.has("vendor_credit_refunds")) {
      ...
      for (int i = 0; i < vendorcreditRefunds.length(); i++) {
        vendorCreditRefunds
            .add(this.jsonToVendorCreditRefund(vendorcreditRefunds.getJSONObject(i)));
      }
   ...
   *
   * @param response
   *          JSON response contains the details of list of vendor credit refunds.
  ...
  public VendorCreditRefundList getVendorCreditRefunds(String response) throws Exception {
    ...
    if (jsonObject.has("vendor_credit_refunds")) {
      ...
      for (int i = 0; i < vendorCreditRefunds.length(); i++) {
        vendorCreditRefundList.add(this.jsonToVendorCreditRefund(vendorCreditRefunds
            .getJSONObject(i)));
      }
    }
   ...
   *
   * @param response
   *          JSON response contains the details of a vendor credit refund.
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of a vendor credit refund.
   * @return Returns the VendorCreditrefund object.
   * @throws JSONException
   *           the JSON exception
   */
   ...
   *
   * @param jsonObject
   *          JSONObject contains the details of the bills credited.
