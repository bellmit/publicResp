...
public class Invoice {
  ...
  /** The payment terms label. */
  private String paymentTermsLabel = "";

  /** The terms. */
  private String terms = "";

  /** The unbilled expenses count. */
  ...
  /** The payment reminder enabled. */
  private boolean paymentReminderEnabled = true;

  /** The can send in mail. */
   ...
   * 
   * @param customerName
   *          Name of the customer the invoice has to be created.
   */
   ...
   * 
   * @param currencyId
   *          ID of the currency associated with the invoice.
   */
   ...
   * 
   * @param isEmailed
   *          To specify the invoice is emailed or not.
   */
   ...
   * 
   * @param remindersSent
   *          Number of invoices sent to the customer.
   */
   ...
   *          Payment expected date for the invoice.
   */
   ...
   *          Last payment date for the invoice.
   */
   ...
   * 
   * @param paymentTerms
   *          Payment terms in days e.g. 15, 30, 60. Invoice due date will be calculated based on
   *          this.
   */
   ...
   * 
   * @param unbilledExpensesCount
   *          Unbilled expense count for the invoice.
   */
   ...
   *          Can the payment be made partially for this invoice.
   */
   ...
   * 
   * @param discount
   *          Discount applied to the invoice. It can be either in % or in amount. e.g. 12.5% or
   *          190.
   */
   ...
   * 
   * @param taxTotal
   *          Total of the tax or tax group applied to the line item.
   */
   ...
   *          Name of the attached file associated with the invoice.
   */
   ...
   * 
   * @param lastReminderSentDate
   *          Last reminder sent date for the invoice.
   */
   ...
   *          Price Precision of the invoice.
   */
   ...
   *          Write off amount for the invoice.
   */
   ...
   * 
   * @param paymentReminderEnabled
   *          To specify the payment reminder is enabled or disabled.
   */
   ...
   * 
   * @param canSendInMail
   *          To specify the email is sent to the invoice or not.
   */
   ...
   *          Last modified time for the invoice.
   */
   ...
   * 
   * @param taxAmountWithheld
   *          Tax amount withheld for the invoice.
   */
   ...
   * 
   * @param amountApplied
   *          Amount applied for the invoice.
   */
   ...
   *          Shipping address of an invoice.
   * @throws Exception
   *           the exception
   */
   ...
   * 
   * @param isViewedByClient
   *          True or false to set the invoice is viewed by client or not.
   */
   ...
   * 
   * @param clientViewedTime
   *          Client viewed time for the invoice.
   */
   ...
   * 
   * @return Returns true if the invoice is stop reminder until payment expected date else returns
   *         false.
   */
   ...
   * 
   * @param stopReminderUntilPaymentExpectedDate
   *          True or false to set the invoice is stop reminder until payment expected date or not.
   */

  public void setStopReminderUntilPaymentExpectedDate(
      boolean stopReminderUntilPaymentExpectedDate) {
   ...
   * 
   * @param isAutobillEnabled
   *          True or false to set the invoice is auto bill enabled or not.
   */
   ...
   *          ID of the tax authority(US Edition only).
   */
   ...
   *          ID of the tax exemption(US Edition only).
   */
