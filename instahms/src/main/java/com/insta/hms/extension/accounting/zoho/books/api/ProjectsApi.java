...
import com.insta.hms.extension.accounting.zoho.books.model.Project;
import com.insta.hms.extension.accounting.zoho.books.model.ProjectList;
import com.insta.hms.extension.accounting.zoho.books.model.Task;
import com.insta.hms.extension.accounting.zoho.books.model.TaskList;
import com.insta.hms.extension.accounting.zoho.books.model.TimeEntry;
import com.insta.hms.extension.accounting.zoho.books.model.TimeEntryList;
...
import com.insta.hms.extension.accounting.zoho.books.parser.ProjectParser;
 ...
 * The list of all invoices created for this project.<br>
 * <br>
 * It is used to:<br>
 * <br>
...
public class ProjectsApi extends API {
   ...
   * <tr>
   * <td>filter_by</td>
   * <td>Filter projects by any status.<br>
   * Allowed Values: <i>Status.All, Status.Active</i> and <i>Status.Inactive</i></td>
   * </tr>
   * <tr>
   * <td>customer_id</td>
   * <td>Search projects by customer id.</td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort projects. <br>
   * Allowed Values: <i>project_name, customer_name, rate</i> and <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   ...
   * The project object which contains projectName, customerId, billingType, userId, and taskName
   ...
   * The Project object which contains projectId is the mandatory parameter for which project
   ...
   * <td>sort_column</td>
   * <td>Sort tasks. <br>
   * Allowed Values: <i>task_name, billed_hours, log_time</i> and <i>un_billed_hours</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   ...
   * The Task object which contains taskId is the mandatory prameter for which task has to be
   * updated.
   * It returns the Task object.
   *
   * @param projectId
   ...
   * The User object which contains userId is the mandatory parameter for which user details has to
   * be updated.
   * It returns the User object.
   *
   * @param projectId
   ...
   * <tr>
   * <td>from_date</td>
   * <td>Date from which the time entries logged to be fetched</td>
   * </tr>
   * <tr>
   * <td>to_date</td>
   * <td>Date up to which the time entries logged to be fetched</td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter time entries by date and status.<br>
   * Allowed Values: <i>Date.All, Date.Today, Date.ThisWeek, Date.ThisMonth, Date.ThisQuarter,
   * Date.ThisYear, Date.PreviousDay, Date.PreviousWeek, Date.PreviousMonth, Date.PreviousQuarter,
   * Date.PreviousYear, Date.CustomDate, Status.Unbilled</i> and <i>Status.Invoiced</i></td>
   * </tr>
   * <tr>
   * <td>project_id</td>
   * <td>Search time entries by project_id.</td>
   * </tr>
   * <tr>
   * <td>user_id</td>
   * <td>Search time entries by user_id.</td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort time entries.<br>
   * Allowed Values: <i>project_name, task_name, user_name, log_date, timer_started_at</i> and
   * <i>customer_name</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   ...
   * The TimeEntry object which contains projectId, taskId, userId, and logDate are the mandatory
   * parameters.
   ...
   * The TimeEntry object which contains timeEntryId is the mandatory parameter for which time entry
   * details has to be updated.
   * It returns the TimeEntry object.
   *
   * @param timeEntry
   ...
   * The queryMap contains the key as mentioned below: <br>
   * <br>
   * time_entry_ids* - ID of the time entries to be deleted.<br>
   * <br>
   ...
   *          Id of the project.
   * @param commentId
   *          Id of the comment for the project
   * @return Returns a String.
   * @throws Exception
   *           the exception
   */
   ...
   * <tr>
   * <td>sort_column</td>
   * <td>Sort invoices raised. <br>
   * Allowed Values: <i>invoice_number, date, total, balance</i> and <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   ...
   *          Id of the project.
   * @param queryMap
   *          Sort invoices raised.
   * @return Retruns the InvoiceList object.
   * @throws Exception
   *           the exception
   */

  public InvoiceList getInvoices(String projectId, HashMap<String, Object> queryMap)
      throws Exception {
