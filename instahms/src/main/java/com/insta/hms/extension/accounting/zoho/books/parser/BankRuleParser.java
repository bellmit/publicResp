...
import com.insta.hms.extension.accounting.zoho.books.model.Criterion;
...
public class BankRuleParser {
   ...
   *
   * @param response
   *          This json response contains list of rules details.
   ...
   *
   * @param response
   *          This json response contains the rule details.
