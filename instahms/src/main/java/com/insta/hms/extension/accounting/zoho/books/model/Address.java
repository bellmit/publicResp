...
public class Address {
  ...
  /** The is update customer. */
  private boolean isUpdateCustomer = false;

  /** The organization address id. */
   ...
   * 
   * @param isUpdateCustomer
   *          You can set this address as default billing address for your customer from now on by
   *          specifying param as true.
   */
   ...
   *          ID of the organization address.
   */
