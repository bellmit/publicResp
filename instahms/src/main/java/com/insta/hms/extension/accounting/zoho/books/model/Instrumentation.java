...
public class Instrumentation {
  ...
  /** The response write time. */
  private int responseWriteTime = 0;

  /** The page context write time. */
   ...
   *          Query execution time for the request.
   */
   ...
   * 
   * @param pageContextWriteTime
   *          Page context write time.
   */
