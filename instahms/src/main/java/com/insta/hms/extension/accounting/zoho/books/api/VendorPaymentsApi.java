...
import com.insta.hms.extension.accounting.zoho.books.model.VendorPaymentList;
 ...
 * The details of a vendor payment.<br>
 * <br>
...
public class VendorPaymentsApi extends API {
  ...
  /** The vendor payment parser. */
  private VendorPaymentParser vendorPaymentParser = new VendorPaymentParser();

  /**
   * Create a payment made to your vendor and you can also apply them to bills either partially or
   * fully.
   ...
   * The VendorPayment object which contains paymentId is the mandatory parameter for which vendor
   * payment details has to be updated.
   * It returns the VendorPayment object.
   *
   * @param vendorPayment
   *          VendorPayment object.
   ...
   * <tr>
   * <td>vendor_name</td>
   * <td>Search payments by vendor name. <br>
   * Variants: <i>vendor_name_startswith and vendor_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>reference_number</td>
   * <td>Search payments by reference number.<br>
   * Variants: <i>reference_number_startswith and reference_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search payments by payment made date.<br>
   * Variants: <i>date_start, date_end, date_before and date_after</i></td>
   * </tr>
   * <tr>
   * <td>amount</td>
   * <td>Search payments by payment amount.<br>
   * Variants: <i>amount_less_than, amount_less_equals, amount_greater_than and
   * amount_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>payment_mode</td>
   * <td>Search payments by payment mode.<br>
   * Variants: <i>payment_mode_startswith and payment_mode_contains</i></td>
   * </tr>
   * <tr>
   * <td>vendor_id</td>
   * <td>Search payments by vendor id.</td>
   * </tr>
   * <tr>
   * <td>bill_id</td>
   * <td>Search payments by bill id.</td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search payments by reference number or vendor name or payment description.</td>
   * </tr>
   * <tr>
   * <td>notes</td>
   * <td>Search payments by notes.<br>
   * Variants: <i>notes_startswith and notes_contains</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   ...
   * PaymentMode.BankRemittance, PaymentMode.Payflowpro and PaymentMode.Others</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort the payment list.<br>
   * Allowed Values: <i>vendor_name, date, reference_number, amount and balance</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
