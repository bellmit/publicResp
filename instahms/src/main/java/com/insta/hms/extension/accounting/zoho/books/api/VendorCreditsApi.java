...
import com.insta.hms.extension.accounting.zoho.books.model.VendorCredit;
import com.insta.hms.extension.accounting.zoho.books.model.VendorCreditList;
import com.insta.hms.extension.accounting.zoho.books.model.VendorCreditRefund;
import com.insta.hms.extension.accounting.zoho.books.model.VendorCreditRefundList;
import com.insta.hms.extension.accounting.zoho.books.parser.VendorCreditsParser;
...
public class VendorCreditsApi extends API {
  ...
  public VendorCredit create(HashMap<String, Object> paramMap, VendorCredit vendorCredit)
      throws Exception {
   ...
   *          ID of the vendor credit bill.
   * @return Returns the success message.
   * @throws Exception
   *           the exception
   */

  public String deleteBillsCredited(String vendorCreditId, String vendorCreditBillId)
      throws Exception {
  ...
  public VendorCreditRefundList getVendorCreditRefunds(HashMap<String, Object> queryMap)
      throws Exception {
  ...
  public VendorCreditRefund getVendorCreditRefund(String vendorCreditId, 
      String vendorCreditRefundId)
      throws Exception {
   ...
   * @param vendorCreditId
   *          ID of the vendor credit.
   * @param vendorCreditRefund
   *          VendorCredit Refund object.
   * @return Returns the VendorCreditRefund object.
   * @throws Exception
   *           the exception
   */

  public VendorCreditRefund refundAVendorCredit(String vendorCreditId,
      VendorCreditRefund vendorCreditRefund) throws Exception {
   ...
   *          ID of the vendor credit.
   * @param vendorCreditRefund
   *          VendorCreditRefund object.
   * @return Returns the VendorCreditRefund object.
   * @throws Exception
   *           the exception
   */

  public VendorCreditRefund updateVendorCreditRefund(String vendorCreditId,
      VendorCreditRefund vendorCreditRefund) throws Exception {
    ...
    String urlString = url + "/" + vendorCreditId + "/refunds/"
        + vendorCreditRefund.getVendorCreditRefundId(); // No I18N
    String response = ZohoHTTPClient.put(urlString, requestBody);
  ...
  public String deleteVendorCreditRefund(String vendorCreditId, String vendorCreditRefundId)
      throws Exception {
