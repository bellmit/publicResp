...
public class Email {
   ...
   * 
   * @param fileName
   *          Name of the file that has been attached to the email.
   */
   ...
   * 
   * @param gatewaysConfigured
   *          To specify the gatewyas configured to the invoice or not.
   */
   ...
   * 
   * @param attachments
   *          Attached files associated with the invoice.
   */
   ...
   *          Email templates for an invoice.
   * @throws Exception
   *           the exception
   */
   ...
   *          Attached file name without extension.
   */
   ...
   * 
   * @param attachPdf
   *          True or false to set the email attached pdf or not.
   */
   ...
   * 
   * @param gatewaysAssociated
   *          True or false to set the invoice is assciated with gateways or not.
   */
