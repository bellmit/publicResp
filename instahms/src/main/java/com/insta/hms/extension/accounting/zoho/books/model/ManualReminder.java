...
public class ManualReminder {
   ...
   * 
   * @param manualreminderId
   *          ID of the manual reminder.
   */
   ...
   * 
   * @param ccMe
   *          To send a carbon copy of the email back to you.
   */
   ...
   *
   * @param invoices
   *          Invoices for the manual reminder.
   * @throws Exception
   *           the exception
   */
   ...
   *
   * @param customers
   *          Customers for the manual reminder.
   * @throws Exception
   *           the exception
   */
   ...
   *
   * @param organizations
   *          Organizations for the manual reminder.
   * @throws Exception
   *           the exception
   */
