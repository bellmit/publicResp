 ...
 * The expense receipt.<br>
 * <br>
 * It is used to update the details of an expense.<br>
 * It is used to add a receipt for the expense.<br>
 * <br>
...
public class ExpensesApi extends API {
   ...
   * @param paidThroughAccountId
   *          ID of the cash/ bank account the expense is paid.
   * @param amount
   *          Expense amount.
  ...
  public Expense create(String accountId, String paidThroughAccountId, double amount)
      throws Exception {
   ...
   * The Expense object which contains expenseId is the mandatory parameter for which expense has to
   * be updated.
   * It returns the Expense object.
   *
   * @param expense
   ...
   *          Expense object.
   * @param file
   *          Expense receipt file to replace existing receipt.
   * @return Returns the Expense object.
   * @throws Exception
   *           the exception
   */
   ...
   * <tr>
   * <td>status</td>
   * <td>Search expenses by expense status.<br>
   * Allowed Values: <i>unbilled, invoiced, reimbursed, non-billable</i> and <i>billable</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter expenses by expense status.<br>
   * Allowed Values: <i>Status.All, Status.Billable, Status.Nonbillable, Status.Reimbursed,
   * Status.Invoiced</i> and <i>Status.Unbilled</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort expenses. <br>
   * Allowed Values: <i>date, account_name, paid_through_account_name, total, bcy_total,
   * reference_number, customer_name, vendor_name</i> and <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   * @param queryMap
   *          It contains the query string parameters in the form of key-value pairs.
