...
public class CustomerPayment {
   ...
   * 
   * @param amount
   *          Payment amount made by the customer.
   */
   ...
   *          Whether is this a single invoice payment or not.
   */
   ...
   * 
   * @param bcyUnusedAmount
   *          Bcy unused amount of the payment.
   */
   ...
   *
   * @param invoices
   *          List of invoices for the payment.
   * @throws Exception
   *           the exception
   */
