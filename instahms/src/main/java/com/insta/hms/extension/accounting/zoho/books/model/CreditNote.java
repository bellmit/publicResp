...
public class CreditNote {
   ...
   *          Reference number of the creditnote.
   */
   ...
   * 
   * @param customerName
   *          Name of the customer the credit note has to be created.
   */
   ...
   *          Last modified time of the creditnote.
   */
   ...
   * 
   * @param isEmailed
   *          Whether the creditnote is emailed or not.
   */
   ...
   * 
   * @param createdTime
   *          Created time of the creditnote.
   */
   ...
   *          Price Precision of the creditnote.
   */
   ...
   *          Total credits used for the creditnote.
   */
   ...
   *          Total refunded amount of the creditnote.
   */
   ...
   *          Contact person(s) for whom credit note has to be sent.
   * @throws Exception
   *           the exception
   */
   ...
   *          BillingAddress of the creditnote.
   * @throws Exception
   *           the exception
   */
   ...
   *          ShippingAddress of the creditnote.
   * @throws Exception
   *           the exception
   */
   ...
   *
   * @param emailHistory
   *          Email history of the creditnote.
   * @throws Exception
   *           the exception
   */
