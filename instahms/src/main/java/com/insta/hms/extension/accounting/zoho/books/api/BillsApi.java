...
import com.insta.hms.extension.accounting.zoho.books.model.Bill;
import com.insta.hms.extension.accounting.zoho.books.model.BillList;
...
import com.insta.hms.extension.accounting.zoho.books.parser.BillParser;
...
public class BillsApi extends API {
   ...
   *
   * @param vendorId
   *          ID of the vendor for whom the bill has to be created.
   * @param billNumber
   *          The bill number.
   * @param accountId
   ...
   * The Bill object which contains vendorId, billNumber, and accountId are the mandatory
   * parameters.
   * It returns the Bill object.
   *
   * @param bill
   ...
   * The Bill object which contains billId is the mandatory parameter for which bill details has to
   * be updated.
   * It returns the Bill object.
   *
   * @param bill
   ...
   *          Bill object.
   * @param file
   *          File is an attachment(It can either be a replacement or new attachment).
   * @return Returns the Bill object.
   * @throws Exception
   *           the exception
   */
   ...
   * <tr>
   * <td>bill_number</td>
   * <td>Search bills by bill number.<br>
   * Variants: <i>bill_number_startswith</i> and <i>bill_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>reference_number</td>
   * <td>Search bills by reference number.<br>
   * Variants: <i>reference_number_startswith</i> and <i>reference_number_contains</i></td>
   * </tr>
   * <tr>
   * <td>date</td>
   * <td>Search bills by bill date.<br>
   * Variants: <i>date_start, date_end, date_before</i> and <i>date.after</i></td>
   * </tr>
   * <tr>
   * <td>description</td>
   * <td>Search bills by description.<br>
   * Variants: <i>description_startswith</i> and <i>description_contains</i></td>
   * </tr>
   * <tr>
   * <td>vendor_name</td>
   * <td>Search bills by vendor name.<br>
   * Variants: <i>vendor_name_startswith</i> and <i>vendor_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>total</td>
   * <td>Search bills by bill total.<br>
   * Variants: <i>total_less_than, total_less_equals, total_greater_than</i> and
   * <i>total_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>vendor_id</td>
   * <td>Search bills by vendor id.</td>
   * </tr>
   * <tr>
   * <td>item_id</td>
   * <td>Search bills by bill item id.</td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search bills by bill number or reference number or vendor name.</td>
   * </tr>
   * <tr>
   * <td>status</td>
   * <td>Search bills by bill status.<br>
   * Allowed Values: <i>paid, open, overdue, void</i> and <i>partially_paid</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter bills by any status.<br>
   * Allowed Values: <i>Status.All, Status.PartiallyPaid, Status.Paid, Status.Overdue,
   * Status.Void</i> and <i>Status.Open</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort bills.<br>
   * Allowed Values: <i>vendor_name, bill_number, date, due_date, total, balance</i> and
   * <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
  ...
  /**
   * Apply vendor credits from excess vendor payments to a bill. (Multiple credits can be applied at
   * once.)
   ...
   *          ID of the bill.
   * @param description
   *          Description is the comment of the bill.
