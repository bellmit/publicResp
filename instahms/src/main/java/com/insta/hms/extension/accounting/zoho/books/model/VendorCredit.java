...
public class VendorCredit {
   ...
   *          Reference number of the vendor credit.
   */
   ...
   * 
   * @param createdTime
   *          Created time for the vendor credit.
   */
   ...
   *          Last modified time of the vendor credit.
   */
   ...
   *          Price precision for the vendor credit.
   */
   ...
   * 
   * @param subTotal
   *          Sub total of the vendor credit.
   */
   ...
   *          Total refund amount for the vendor credit.
   */
   ...
   * 
   * @param vendorCreditRefunds
   *          List of VendorCreditRefund object.
   */
