...
public class ChartOfAccount {
  ...
  /** The is involved in transaction. */
  private boolean isInvolvedInTransaction = false;

  /** The is system account. */
   ...
   * 
   * @param accountTypeFormatted
   *          Format of the account type.
   */
   ...
   * 
   * @param isActive
   *          Is the account is active or not.
   */
   ...
   * 
   * @param isInvolvedInTransaction
   *          Is the account involved in transaction.
   */
   ...
   *          Is the account is system generated.
   */
