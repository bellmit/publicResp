...
public class PurchaseOrder {
  ...
  /** The delivery org address id. */
  private String deliveryOrgAddressId;

  /** The delivery customer id. */
  ...
  /** The can mark as bill. */
  private boolean canMarkAsBill;

  /** The can mark as unbill. */
   ...
   * 
   * @param isEmailed
   *          True or false to set the purchase order is emailed or not.
   */
   ...
   * 
   * @param shipVia
   *          Ship via for the purchase order.
   */
   ...
   * 
   * @param deliveryOrgAddressId
   *          ID of the delivery org address.
   */
   ...
   * 
   * @param canMarkAsBill
   *          True or flase to set the order can mark as bill or not.
   */
   ...
   * 
   * @param canMarkAsUnbill
   *          True or false to set the order can mark as bill or not.
   */
