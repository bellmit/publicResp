...
public class ContactPersonsApi extends API {
   ...
   * The ContactPerson object must contain the contactPersonId for which contact person details has
   * to be updated.
   ...
   * Pass the contact person id to change the status of the particular contact person as primary for
   * the contact.
   ...
   *
   * @param contactId
   *          ID of contact to which contact persons has to be created.
