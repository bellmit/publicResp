...
public class ProjectParser {
   ...
   *
   * @param response
   *          This json response contains list of projects details.
   ...
   *
   * @param response
   *          This json response contains the project details.
   ...
   *
   * @param response
   *          This json response contains list of tasks details for project.
   ...
   *
   * @param response
   *          This json response contains the task details for project.
   ...
   *
   * @param response
   *          This json response contains list of users details for project.
   ...
   *
   * @param response
   *          This json response contains the user details for project.
   ...
   *
   * @param response
   *          This json response contains list of time entries details for project.
  ...
  public TimeEntryList getTimeEntries(String response) throws Exception {
    ...
    for (int i = 0; i < jsonArray.length(); i++) {
      ...
      // No I18N
      timeEntry.setIsCurrentUser(jsonArray.getJSONObject(i).getBoolean("is_current_user"));
      ...
      timeEntry.setTimerDurationInMinutes(jsonArray.getJSONObject(i).getInt(
          "timer_duration_in_minutes")); // No I18N
   ...
   *
   * @param response
   *          This json response contains the time entry details for project.
   ...
   *
   * @param response
   *          This json response contains list of comments details for project.
   ...
   *
   * @param response
   *          This json response contains the comment details for project.
   ...
   *
   * @param response
   *          This json response contains list of invoices details for project.
