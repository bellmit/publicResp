...
public class ContactPerson {
   ...
   *          Whether this is the primary contact of the contact person or not.
   */
   ...
   * 
   * @param isAddedInPortal
   *          True or false to set the contact person is added in portal.
   */
   ...
   * 
   * @param canInvite
   *          True or false to set the contact person can be invite again or not.
   */
