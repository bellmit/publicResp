...
import com.insta.hms.extension.accounting.zoho.books.model.SalesOrder;
import com.insta.hms.extension.accounting.zoho.books.model.SalesOrderList;
import com.insta.hms.extension.accounting.zoho.books.model.TemplateList;
import com.insta.hms.extension.accounting.zoho.books.parser.SalesOrderParser;
 ...
 * Add a comment for the sales order.<br>
 * <br>
...
public class SalesOrderApi extends API {
  ...
  public SalesOrder create(HashMap<String, Object> queryMap, SalesOrder salesOrder)
      throws Exception {
  ...
  public SalesOrder update(HashMap<String, Object> queryMap, SalesOrder salesOrder)
      throws Exception {
  ...
  /**
   * Email a sales order to the customer. Input json string is not mandatory. If input json string
   * is empty, mail will be send with default mail content.
   *
   * @param salesorderId
   *          ID of the sales order.
   * @param paramMap
  ...
  public String sendEmail(String salesorderId, HashMap<String, Object> paramMap, Email email)
      throws Exception {
  ...
  public Email getEmailContent(String salesorderId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  /**
   * Updates the billing address for this sales order alone. You can set this address as default
   * billing address for your customer by specifying 'is_update_customer' param as true.
   *
   * @param salesorderId
   *          ID of the sales order.
   * @param address
  ...
  /**
   * Updates the shipping address for this sales order alone. You can set this address as default
  ...
  public File getAttachment(String salesorderId, 
  ...
  public String addAttachment(String salesorderId, HashMap<String, Object> queryMap, File file)
      throws Exception {
  ...
  public String updateAttachment(String salesorderId, HashMap<String, Object> queryMap)
      throws Exception {
  ...
  public Comment updateComment(String salesorderId, String commentId, String description)
      throws Exception {
