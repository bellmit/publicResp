...
public class BankAccount {
   ...
   * 
   * @param currencyId
   *          Currency in which this account is created.
   */
   ...
   * 
   * @param currencyCode
   *          Currency code in which this account is created.
   */
   ...
   * 
   * @param uncategorizedTransactions
   *          uncategorized transactions for this account.
   */
   ...
   * 
   * @param isActive
   *          A boolean value to make this account is active.
   */
   ...
   *          A boolean value to make the account primary.
   */
   ...
   * 
   * @param isPaypalAccount
   *          A boolean value to specify if it is a paypal account.
   */
