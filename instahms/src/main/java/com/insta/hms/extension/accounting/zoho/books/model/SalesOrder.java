...
public class SalesOrder {
   ...
   * 
   * @param shipmentDays
   *          Shipment days for the sales order.
   */
   ...
   * 
   * @param createdTime
   *          Created time of the sales order.
   */
   ...
   * 
   * @param isEmailed
   *          True or false to set the sales order is emailed or not.
   */
   ...
   *          True or false to set the sales order is discount before tax or not.
   */
   ...
   *          ID of the order delivery method.
   */
   ...
   *          Adjustment description of the order.
   */
   ...
   * 
   * @param canSendInMail
   *          True or false to set the order can send in mail or not.
   */
