...
public class EstimateSetting {
   ...
   * 
   * @param autoGenerate
   *          To enable or disable auto number generation.
   */
   ...
   *          ID of the template that has been used as default template for an entity.
   */
   ...
   * 
   * @param termsToInvoice
   *          To determine whether terms and conditions field is to be copied from estimate to
   *          invoice.
   */
   ...
   * 
   * @param notesToInvoice
   *          To determine whether customer notes field is to be copied from estimate to invoice.
   */
   ...
   * 
   * @param warnEstimateToInvoice
   *          To warn estimate to invoice conversion.
   */
