...
public class Journal {
   ...
   * 
   * @param currencyId
   *          ID of the currency which the journal associated with.
   */
   ...
   *          Price precision for the journal.
   */
   ...
   *          Last modified time for the journal.
   */
