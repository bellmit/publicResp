...
import com.insta.hms.extension.accounting.zoho.books.parser.RecurringExpenseParser;
 ...
 * The list of all comments for the recurring expense.<br>
 * <br>
 * It is used to change the status:<br>
 * <br>
 * Stop an active recurring expense.<br>
 * Resume a stopped recurring expense.<br>
 * <br>
...
public class RecurringExpensesApi extends API {
   ...
   * The RecurringExpense object which contains accountId, paidThroughAccountId, recurrenceName,
   * startDate, recurrenceFrequency, repeatEvery, and amount are the mandatory parameters.
   ...
   * The RecurringExpense object which contains recurringExpenseId is the mandatory parameter for
   * which recurring expense has to be updated.
   * It returns the RecurringExpense object.
   *
   * @param recurringExpense
   *          RecurringExpense object.
   ...
   * <td>Search recurring expenses by recurring expense name.<br>
   * Variants: <i>recurrence_name_startswith</i> and <i>recurrence_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>last_created_date</td>
   * <td>Search recurring expenses by date on when last expense was generated.<br>
   * Variants: <i>last_created_date_start, last_created_date_end, last_created_date_before</i> and
   * <i>last_created_date_after</i></td>
   * </tr>
   * <tr>
   * <td>next_expense_date</td>
   * <td>Search recurring expenses by date on which next expense will be generated.<br>
   * Variants: <i>next_expense_date_start, next_expense_date_end, next_expense_date_before</i> and
   * <i>next_expense_date_after</i></td>
   * </tr>
   * <tr>
   * <td>amount</td>
   * <td>Search recurring expenses by amount.<br>
   * Variants: <i>amount_less_than, amount_less_equals, amount_greater_than</i> and
   * <i>amount_greater_equals</i></td>
   * </tr>
   * <tr>
   * <td>account_name</td>
   * <td>Search recurring expenses by expense account.<br>
   * Variants: <i>account_name_startswith</i> and <i>account_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_name</td>
   * <td>Search recurring expenses by customer name.<br>
   * Variants: <i>customer_name_startswith</i> and <i>customer_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>vendor_name</td>
   * <td>Search recurring expenses by vendor name.<br>
   * Variants: <i>vendor_name_startswith</i> and <i>vendor_name_contains</i></td>
   * </tr>
   * <tr>
   * <td>customer_id</td>
   * <td>Search recurring expenses by customer id.</td>
   * </tr>
   * <tr>
   * <td>vendor_id</td>
   * <td>Search recurring expenses by vendor id.</td>
   * </tr>
   * <tr>
   * <td>paid_through_account_id</td>
   * <td>Search expenses by paid through account id.</td>
   * </tr>
   * <tr>
   * <td>description</td>
   * <td>Search recurring expenses by description.<br>
   * Variants: <i>description_startswith</i> and <i>description_contains</i></td>
   * </tr>
   * <tr>
   * <td>search_text</td>
   * <td>Search recurring expenses by recurrence name or customer name.</td>
   * </tr>
   * <tr>
   * <td>status</td>
   * <td>Search recurring expenses by recurring expense status.<br>
   * Allowed Values: <i>active, stopped</i> and <i>expired</i></td>
   * </tr>
   * <tr>
   * <td>filter_by</td>
   * <td>Filter recurring expenses by status.<br>
   * Allowed Values: <i>RecExpenseStatus.All, RecExpenseStatus.Active, RecExpenseStatus.Stopped</i>
   * and <i>RecExpenseStatus.Expired</i></td>
   * </tr>
   * <tr>
   * <td>sort_column</td>
   * <td>Sort recurring expenses.<br>
   * Allowed Values: <i>recurrence_name, last_created_date, next_expense_date, account_name,
   * paid_through_account_name, total, customer_name, vendor_name</i> and <i>created_time</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
  ...
  public RecurringExpenseList getRecurringExpenses(HashMap<String, Object> queryMap)
      throws Exception {

    String response = ZohoHTTPClient.get(url, getQueryMap(queryMap));

    RecurringExpenseList recurringExpenseList = recurringExpenseParser
        .getRecurringExpenses(response);
   ...
   * <tr>
   * <td>sort_column</td>
   * <td>Sort child expenses created.<br>
   * Allowed Values: <i>date, account_name, vendor_name, paid_through_account_name,
   * customer_name</i> and <i>total</i></td>
   * </tr>
   * </tbody>
   * </table>
   *
   ...
   *          ID of the recurring expense.
   * @param queryMap
   *          Sort child expenses created.
   * @return Returns the ExpenseList object.
   * @throws Exception
   *           the exception
   */

  public ExpenseList getExpensesCreated(String recurringExpenseId, HashMap<String, Object> queryMap)
      throws Exception {
