...
public class JournalParser {
   ...
   *
   * @param response
   *          This json response contains the journal details.
  ...
  public Journal getJournal(String response) throws Exception {
    ...
    for (int i = 0; i < lineItems.length(); i++) {
      ...
      // lineItem.setTaxPercentage(lineItems.getJSONObject(i).getDouble("tax_percentage")); //No
      // I18N
   ...
   *
   * @param response
   *          This json response contains list of journals details.
