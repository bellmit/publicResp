...
public class EmailHistory {
   ...
   * 
   * @param from
   *          From email id of the mail history.
   */
   ...
   * 
   * @param toMailIds
   *          To mail ids of the mail history.
   */
