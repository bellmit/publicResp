...
/**
 * TestVisitReportsAuditLogIdSequence generated by hbm2java
 */
@Embeddable
public class TestVisitReportsAuditLogIdSequence implements java.io.Serializable {
	...
	public TestVisitReportsAuditLogIdSequence() {
	}

	public TestVisitReportsAuditLogIdSequence(int logId, Date modTime) {
		this.logId = logId;
		this.modTime = modTime;
	}

	public TestVisitReportsAuditLogIdSequence(int logId, Integer reportId, String patientId, String category, String userName,
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof TestVisitReportsAuditLogIdSequence))
			return false;
		TestVisitReportsAuditLogIdSequence castOther = (TestVisitReportsAuditLogIdSequence) other;
